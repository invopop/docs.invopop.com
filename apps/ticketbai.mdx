...
The TicketBAI app and its associated workflow actions allow you to  generate, send or cancel TicketBAI invoices. Please refer to the [TicketBAI guide](/guides/es-ticketbai) for a step-by-step configuration process in your workflows.
