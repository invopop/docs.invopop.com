...
import InvoiceWorkflow from '/snippets/workflows/es/verifactu-invoice.mdx';
import RegisterWorkflow from '/snippets/workflows/es/verifactu-supplier-registration.mdx';
import UnregisterWorkflow from '/snippets/workflows/es/verifactu-unregister.mdx';
import CancelWorkflow from '/snippets/workflows/es/verifactu-cancel.mdx';
import CancelInvoice from '/snippets/workflows/es/verifactu-cancel.mdx';
...
import FAQ from '/snippets/faqs/es/composers/app-verifactu.mdx';
