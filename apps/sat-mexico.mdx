...
<Tabs>
  ...
  <Tab title="Description">
    <div class="flex gap-8">
      <Card
        title="SAT Mexico"
        icon="https://assets.invopop.com/apps/sat-mexico/icon.svg"
  ...
  <Tab title="Actions">
    ...
    <Card title="Generate CFDI XML" icon="https://assets.invopop.com/apps/sat-mexico/icon.svg" horizontal>
    ...
    <Card title="Stamp CFDI (PAC)" icon="https://assets.invopop.com/apps/sat-mexico/icon.svg" horizontal>
      Sends unsigned CFDI XML to an authorized PAC to obtain Timbre Fiscal Digital (UUID, timestamp, seal, QR data).
    </Card>

    <Card title="Attach Stamped CFDI" icon="https://assets.invopop.com/apps/sat-mexico/icon.svg" horizontal>
