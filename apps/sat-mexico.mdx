...
<Tabs>
  <Tab title="Description">
    ...
    Check out our [Supplier registration guide](/guides/mx-sat-supplier) for onboarding suppliers, the [Issuing invoices guide](/guides/mx-sat-issuing) for issuing invoices, or the [Receiving invoices guide](/guides/mx-sat-receiving) for importing CFDIs.
