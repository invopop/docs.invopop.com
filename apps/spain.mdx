...
<Tabs>
	<Tab title="Description">
		<Columns cols="2">
			...
			<Card title="SII Onboarding Guide" icon="https://assets.invopop.com/apps/sii/icon.svg"
	...
	**SII Key Features**
	...
	2. **SII Reporting:** Invoices are reported directly to the AEAT through the SII system API, ensuring compliance with Spanish tax reporting requirements.
