...
import RegisterWorkflow from '/snippets/workflows/es/sii-register.mdx';
import UnregisterWorkflow from '/snippets/workflows/es/sii-unregister.mdx';
import FacturaeWorkflow from '/snippets/workflows/es/facturae.mdx';
import TicketBAIInvoiceWorkflow from '/snippets/workflows/es/ticketbai-invoice.mdx';
import TicketBAICancelWorkflow from '/snippets/workflows/es/ticketbai-cancel.mdx';
import TicketBAISupplierRegistration from '/snippets/workflows/es/ticketbai-supplier-registration.mdx';
import TicketBAIUnregister from '/snippets/workflows/es/ticketbai-unregister.mdx';
import NoverifactuInvoiceWorkflow from '/snippets/workflows/es/noverifactu-invoice.mdx';
import NoverifactuCancelWorkflow from '/snippets/workflows/es/noverifactu-cancel.mdx';
import NoverifactuRegisterWorkflow from '/snippets/workflows/es/noverifactu-supplier-registration.mdx';
import NoverifactuUnregisterWorkflow from '/snippets/workflows/es/noverifactu-unregister.mdx';
import NoverifactuEventWorkflow from '/snippets/workflows/es/noverifactu-event.mdx';
import NoverifactuSummaryEventWorkflow from '/snippets/workflows/es/noverifactu-summary-event.mdx';
...
import Customer from '/snippets/parties/es/customer.mdx';
import SpainResources from '/snippets/tables/spain-resources.mdx';
import FAQ from '/snippets/faqs/es/composers/app-spain.mdx';
...
<Tabs>
	...
	Invopop's **Spain app** provides integration with Spanish tax agencies, centralizing all compliance requirements for electronic invoicing and tax reporting in Spain.
	...
	| **Compliant documents** | XML generation and PDF with QR codes | Invoice reporting to AEAT via SII API ([with limitations](#sii-implementation-scope)) |
	...
	<AccordionGroup>
		<Accordion title="NO VERI*FACTU issue invoice">
			<NoverifactuInvoiceWorkflow />
		</Accordion>
		<Accordion title="NO VERI*FACTU cancel invoice">
			<NoverifactuCancelWorkflow />
		</Accordion>
	</AccordionGroup>
	...
	<AccordionGroup>
		<Accordion title="NO VERI*FACTU register supplier">
			<NoverifactuRegisterWorkflow />
		</Accordion>
		<Accordion title="NO VERI*FACTU unregister supplier">
			<NoverifactuUnregisterWorkflow />
		</Accordion>
	</AccordionGroup>
	...
	<AccordionGroup>
		<Accordion title="NO VERI*FACTU process event">
			<NoverifactuEventWorkflow />
		</Accordion>
		<Accordion title="NO VERI*FACTU summary event">
			<NoverifactuSummaryEventWorkflow />
		</Accordion>
	</AccordionGroup>
	...
	<Tab title="Documents">
		<AccordionGroup>
			<Accordion title="Supplier">
				A Spanish company with its NIF and the legal representative required for supplier registration.
				<Supplier />
			</Accordion>
			<Accordion title="Customer">
				A Spanish business customer identified by NIF with a full address.
				<Customer />
			</Accordion>
		</AccordionGroup>
