	...
	<Tab title="Description">
		<div class="flex gap-8">
			<Card title="DIAN Colombia" icon="https://assets.invopop.com/apps/dian-colombia/icon.svg"
			  href="/guides/co-dian" cta="View implementation guide">
					Issue invoices and credit notes through DIAN.
			</Card>
			<div class="flex-shrink">
				...
				| Category | Government |
				| Country | [Colombia](/countries/colombia) |
				| Docs | [Implementation&nbsp;guide](/guides/co-dian) |
		</div>
	</div>
