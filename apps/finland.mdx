...
<Tabs>
	...
	<Tab title="Actions">
		...
		<Card title="Sign authorization" icon="https://assets.invopop.com/flags/fi.svg" horizontal>
		 Publish a signing link on the party's entry where its representative signs the authorization agreement and verifies their identity.
		</Card>

		<Card title="Wait for approval" icon="https://assets.invopop.com/flags/fi.svg" horizontal>
		 Pause the workflow until the signed authorization is approved, then continue on its own.
		</Card>
