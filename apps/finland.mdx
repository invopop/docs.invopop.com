	...
	<Tab title="Documents">
		<AccordionGroup>
			<Accordion title="Finland supplier">
				...
				<Supplier />
				A supplier in Sweden, Denmark, Norway or Estonia can also send through this app, carrying its own tax ID and its own electronic address — for a Swedish company, its `0007` Peppol identifier. Those suppliers can send only; see the [supplier registration guide](/guides/fi-finvoice-supplier#suppliers-outside-finland).
			</Accordion>
