	...
	<Tab title="Description">
		<Columns cols="2">
			<Card title="Peppol" icon="https://assets.invopop.com/apps/peppol/icon.svg"
			  href="/guides/peppol" cta="View implementation guide">
					Send and receive invoices through the global Peppol network.
			</Card>
				|               |       |
				|---------------|-------|
				| Developer | [Invopop](https://invopop.com) |
				| Category | Network |
				| Countries | [Multiple](/guides/peppol) |
				| Docs | [Implementation&nbsp;guide](/guides/peppol) |
		</Columns>
