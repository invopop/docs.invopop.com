...
<Tabs>
	...
	**Invoices:**
	- **FT** - *_Fatura_* (Standard Invoice)
	- **FS** - *_Fatura Simplificada_* (Simplified Invoice)
	- **FR** - *_Fatura-Recibo_* (Invoice-Receipt)
	- **ND** - *_Nota de Débito_* (Debit Note)
	- **NC** - *_Nota de Crédito_* (Credit Note)

	**Payment receipts:**
	- **RG** - *_Outro Recibo_* (Other Receipt)

	**Transport documents:**
	- **GT** - *_Guia de transporte_* (Waybill)
