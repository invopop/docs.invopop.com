...
import RegistrationWorkflow from '/snippets/workflows/pl/pl-register.mdx';
...
import Supplier from '/snippets/parties/pl/supplier.mdx';
import Customer from '/snippets/parties/pl/customer.mdx';
import FAQ from '/snippets/faqs/pl/composers/app-ksef.mdx';

<Tabs>
	<Tab title="Description">
		<Columns cols="2">
			<div class="flex flex-col grow items-center justify-center">
				<Card title="Register suppliers" icon="https://assets.invopop.com/flags/pl.svg"
				  href="/guides/pl-ksef-supplier" horizontal>
				  Supplier registration guide ›
				</Card>
				<Card title="Issue invoices" icon="https://assets.invopop.com/flags/pl.svg"
				  href="/guides/pl-ksef" horizontal>
				  Issuing guide ›
				</Card>
				<Card title="Receive invoices" icon="https://assets.invopop.com/flags/pl.svg"
				  href="/guides/pl-ksef-receiving" horizontal>
				  Receiving guide ›
				</Card>
			</div>
	...
	* **KSeF 2.0 integration:** Direct integration with KSeF 2.0, Poland's official national platform for electronic invoicing.
	...
	Check out our [Supplier registration guide](/guides/pl-ksef-supplier) for registering parties with KSeF, the [Issuing invoices guide](/guides/pl-ksef) for issuing invoices, and the [Receiving invoices guide](/guides/pl-ksef-receiving) for importing received invoices.
	...
	<Tab title="Documents">
		...
		<AccordionGroup>
			<Accordion title="KSeF supplier">
				A supplier with a 10-digit NIP, used both for party registration and as the invoice issuer.
				<Supplier />
			</Accordion>
			<Accordion title="KSeF customer">
				A business customer identified by NIP.
				<Customer />
			</Accordion>
		</AccordionGroup>
		...
		For more examples and detailed documentation, visit the [Supplier registration](/guides/pl-ksef-supplier), [Issuing invoices](/guides/pl-ksef), and [Receiving invoices](/guides/pl-ksef-receiving) guides.
	</Tab>
</Tabs>
