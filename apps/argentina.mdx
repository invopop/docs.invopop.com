...
import RegisterSupplier from '/snippets/workflows/ar/ar-supplier-registration.mdx';
import IssueInvoice from '/snippets/workflows/ar/ar-invoice.mdx';
import ExampleAccordion from '/snippets/invoices/ar/accordion.mdx';
import Supplier from '/snippets/parties/ar/supplier.mdx';
import Customer from '/snippets/parties/ar/customer.mdx';
import ArgentinaResources from '/snippets/tables/argentina-resources.mdx';
import FAQ from '/snippets/faqs/ar/composers/app-arca.mdx';
...
<Tabs>
	...
	Invopop's **Argentina app** connects to ARCA (Agencia de Recaudación y Control Aduanero), Argentina's national tax and customs authority, enabling automated invoice submission, authorization, and reporting through ARCA's clearance model.
	...
	**Key features**
	...
	<Tab title="Documents">
		...
		<AccordionGroup>
			<Accordion title="ARCA supplier">
				A supplier with an 11-digit CUIT and the fiscal address used when registering with ARCA.
				<Supplier />
			</Accordion>
			<Accordion title="ARCA customer">
				A business customer identified by CUIT. The customer's tax status determines the invoice type (A, B, or C).
				<Customer />
			</Accordion>
		</AccordionGroup>
