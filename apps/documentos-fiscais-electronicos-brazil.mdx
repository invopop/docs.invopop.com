...
<Tabs>
	<Tab title="Description">
		<div class="flex gap-8">
			...
			<div class="flex-shrink">
				...
				| Category | Government |
				| Country | [Brazil](/countries/brazil) |
	...
	* **NFS-e and NFC-e Support:** Issue B2B and B2C invoices for service and consumer transactions.
	...
	<Tab title="Actions">
		...
		<Card title="Send NFS-e (Brazil)" icon="https://assets.invopop.com/apps/documentos-fiscais-electronicos-brazil/icon.svg" horizontal>
		 <div class="pop-count"><Icon icon="https://assets.invopop.com/icons/pops.svg" /> 5</div>
		 Send NFS-e in Brazil via Plugnotas.
		</Card>
		<Card title="Send NFC-e (Brazil)" icon="https://assets.invopop.com/apps/documentos-fiscais-electronicos-brazil/icon.svg" horizontal>
		 <div class="pop-count"><Icon icon="https://assets.invopop.com/icons/pops.svg" /> 5</div>
		 Send NFC-e in Brazil via Plugnotas
		</Card>
		<Card title="Register DF-e supplier (Brazil)" icon="https://assets.invopop.com/apps/documentos-fiscais-electronicos-brazil/icon.svg" horizontal>
