---
title: "Documentos fiscais eletrônicos Brazil"
description: "Send NF-e, NFC-e & NFS-e documents to the tax authorities in Brazil via PlugNotas."
...
import PostRegistrationWorkflow from '/snippets/workflows/br/dfe-postregistration.mdx';
import RegisterWorkflow from '/snippets/workflows/br/dfe-register-supplier.mdx';
import UnregisterWorkflow from '/snippets/workflows/br/dfe-unregister-supplier.mdx';
import ExampleAccordion from '/snippets/invoices/br/accordion.mdx';
import Supplier from '/snippets/parties/br/supplier.mdx';
import Customer from '/snippets/parties/br/customer.mdx';
import BrazilResources from '/snippets/tables/brazil-resources.mdx';
import FAQ from '/snippets/faqs/br/composers/app-dfe.mdx';

<Tabs>
	<Tab title="Description">
		<Columns cols="2">
			<div class="flex flex-col grow items-center justify-center">
				<Card title="Register suppliers" icon="https://assets.invopop.com/apps/notas-fiscais-eletronicas-brazil/icon.svg"
				  href="/guides/br-dfe-supplier" horizontal>
				  Supplier registration guide ›
				</Card>
				<Card title="Issue invoices" icon="https://assets.invopop.com/apps/notas-fiscais-eletronicas-brazil/icon.svg"
	...
	* **NFS-e, NF-e, and NFC-e support:** Issue invoices for service, B2B product, and consumer transactions.
	...
	Make sure to check out our [Supplier registration guide](/guides/br-dfe-supplier) for onboarding suppliers, and the [Issuing invoices guide](/guides/br-dfe) for issuing documents and setting up your workflows.
	...
	<Tab title="Actions">
		...
		<Card title="Unregister supplier in Brazil" icon="https://assets.invopop.com/apps/notas-fiscais-eletronicas-brazil/icon.svg" horizontal>
		 Remove a supplier's registration so it can no longer issue electronic fiscal documents from this workspace.
		</Card>
		...
		<Card title="Look up municipality codes" icon="https://assets.invopop.com/apps/notas-fiscais-eletronicas-brazil/icon.svg" horizontal>
		 Fill in missing IBGE municipality codes (`br-ibge-municipality`) on invoices and parties from each party's postal code (CEP). Values already set are never overridden.
		</Card>
	</Tab>
	...
	<Tab title="Workflows">
		...
		<AccordionGroup>
			<Accordion title="DF-e supplier post-registration">
			This workflow marks a supplier as registered after successful onboarding.
				<PostRegistrationWorkflow />
				[Add to my workspace →](https://console.invopop.com/redirect/workflows/new?template=br-dfe-postregistration)
			</Accordion>
			<Accordion title="DF-e register supplier">
			This workflow registers a supplier so it can issue electronic fiscal documents from this workspace.
				<RegisterWorkflow />
				[Add to my workspace →](https://console.invopop.com/redirect/workflows/new?template=br-dfe-register-supplier)
			</Accordion>
			<Accordion title="DF-e unregister supplier">
			This workflow removes a supplier's registration so it can no longer issue electronic fiscal documents from this workspace.
				<UnregisterWorkflow />
				[Add to my workspace →](https://console.invopop.com/redirect/workflows/new?template=br-dfe-unregister-supplier)
			</Accordion>
		</AccordionGroup>
	</Tab>
	<Tab title="Documents">
		...
		<AccordionGroup>
			<Accordion title="DF-e Brazil supplier">
				A CNPJ with the municipal and state registrations, IBGE municipality code, and Simples Nacional flag used by the DF-e flows.
				<Supplier />
			</Accordion>
			<Accordion title="DF-e Brazil customer">
				A business customer with CNPJ, full address including state, and IBGE municipality code.
				<Customer />
			</Accordion>
		</AccordionGroup>
