...
<Tabs>
	<Tab title="Description">
		...
		* **VAT group onboarding**: a single VAT number can hold several registrations, one per [supplier identity](/guides/sa-zatca-registration#vat-groups), each with its own CSID and invoice chain.
