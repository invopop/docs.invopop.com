...
<Tabs>
	...
	* **White-Label:** the process allows issuance on behalf of clients (white-label) or directly as an organization, according to user needs.
	...
	<Tab title="Documents">
		<AccordionGroup>
			<Accordion title="IAPR Greece Services Invoice (B2B)">
				<B2BServicesInvoice />
			</Accordion>
			<Accordion title="IAPR Greece Retail Sales Receipt (B2C)">
				<B2CGoodsInvoice />
			</Accordion>
			<Accordion title="IAPR Greece Climate Fee Collection (B2B)">
