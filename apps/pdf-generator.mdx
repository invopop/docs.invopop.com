...
import WorkflowExample from '/snippets/workflows/pdf/invoice.mdx';
...
<Tabs>
	<Tab title="Description">
		<Columns cols="2">
			<div class="flex flex-col grow items-center justify-center">
				<Card title="PDF Generator" icon="https://assets.invopop.com/apps/pdf/logo.svg"
				  href="/guides/pdf-invoice" horizontal>
		...
		The PDF Generator app converts GOBL (Go Business Language) documents into professional PDF invoices and documents. This app is designed for tax regimes that don't require electronic reporting or invoicing, useful for generating simple PDF invoices that can be sent directly to customers.
	...
	* **Workflow integration:** Runs inside Invopop workflows alongside other processing steps.
