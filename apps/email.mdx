...
The Email app and its associated workflow actions allow you to  email invoices and send notifications. Please refer to the [email guide](/guides/email) for a step-by-step configuration process.
