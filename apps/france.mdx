...
<Tabs>
	...
	<Tab title="Actions">
		...
		<Card title="Record invoice" icon="https://assets.invopop.com/apps/peppol/icon.svg" horizontal>
			...
			Record the invoice in the directory ahead of transmission and PPF reporting. **Requires the `fr-ctc-flow2-v1` add-on on the invoice** — the action rejects envelopes without it.
		</Card>
