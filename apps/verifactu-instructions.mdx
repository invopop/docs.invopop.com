...
description: Implement VERI*FACTU in your workspace 
keywords: ['verifactu']
---

This guide will get you started in Sandbox, onboard your suppliers, issue invoices, credit notes and corrective invoices, as well as taking your workspace live.

## Quickstart in Sandbox
...
4. Create a new Silo Entry
5. Run the invoicing workflow
  </Tab>
  <Tab title="API">
1. Create a new Party
2. Upload documentation
...
## Onboard a supplier (Live)

These steps do not apply if you are a B2B client.

<Tabs>
  <Tab title="Console">
1. Upload a supplier (Console/API)
2. Run the supplier registration workflow
3. Wait for the supplier to complete his registration
  </Tab>
  <Tab title="API">
1. Upload a supplier (Console/API)
2. Run the supplier registration workflow
...
## Handle supplier rejections

These steps do not apply if you are a B2B client.

<Tabs>
  <Tab title="Console">
    1. Run the rejected supplier workflow
  </Tab>
  <Tab title="API">
    1. Run the rejected supplier workflow
  </Tab>
...
<Tabs>
  <Tab title="Console">
    1. Run the unregister supplier workflow
  </Tab>
  <Tab title="API">
    1. Run the unregister supplier workflow
  </Tab>
...
You can skip this step if you are a B2B client.

<Tabs>
  <Tab title="Console">
    1. Upload an invoice
    2. Run the issue invoice workflow
  </Tab>
  <Tab title="API">
    1. Upload an invoice
    2. Run the issue invoice workflow
