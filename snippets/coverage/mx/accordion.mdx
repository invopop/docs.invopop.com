...
| Pago | Payment receipts (REP / comprobante de pago) issued as payments are collected against PPD invoices. |

**Method of payment**

| Code | Description |
|---|---|
| `PUE` | Pago en Una sola Exhibición (single up-front payment) |
