            ...
            "next": [
                {
                    ...
                    "steps": [
                        ...
                        },
                        {
                            ...
                            "summary": "Record Sender invoice",
                            "config": {
                                "role": "sender"
                            }
                        },
                        {
                            "id": "ee6e4850-b287-11f1-b757-63253ab36402",
                            ...
                            "next": [
                                ...
                                },
                                {
                                    ...
                                    "steps": [
                                        {
                                            "id": "f4954b70-b287-11f1-b757-63253ab36402",
                                            "name": "Forward document to PPF",
                                            "provider": "gov-fr.directory.forward",
...
```json Chargebee France send invoice workflow
{
    "name": "Chargebee France send invoice",
    "description": "Sync from Chargebee and forward to PPF or record for reporting",
    "schema": "bill/invoice",
