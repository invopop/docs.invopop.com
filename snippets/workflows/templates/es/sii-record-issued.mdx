---
title: "SII record issued invoice"
description: "Generate SII record for an issued invoice and send it to the AEAT"
countryCode: "es"
appId: "sii"
schema: "bill/invoice"
---

```json Example SII issued invoice workflow with states expandable
{
  "name": "SII record issued invoice",
  "description": "Generate SII record for an issued invoice and send it to the AEAT",
  "schema": "bill/invoice",
  "steps": [
    {
