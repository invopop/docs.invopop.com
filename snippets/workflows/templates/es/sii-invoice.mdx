---
title: "SII record invoice"
description: "Generate SII record and send it to the AEAT"
countryCode: "es"
appId: "sii"
schema: "bill/invoice"
---

```json Example SII invoice workflow with states expandable
{
  "name": "SII record invoice",
  "description": "Generate SII record and send it to the AEAT",
  "schema": "bill/invoice",
  "steps": [
    {
    ...
    },
    {
      ...
      "name": "Record invoice in SII",
      "provider": "gov-es.sii.record"
    },
    {
