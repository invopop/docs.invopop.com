...
<AccordionGroup>
	...
	<Accordion title="Example B2C consumer invoice (NFC-e)">
		...
		- we've added the [`br-nfe-v4`](https://docs.gobl.org/addons/br-nfe-v4) addon; this ensures the document will be validated using the NF-e/NFC-e rules built into the [GOBL](https://docs.gobl.org) library,
