import StandardMin from '/snippets/invoices/es/peppol-vf-standard.min.mdx';
import Standard from '/snippets/invoices/es/peppol-vf-standard.mdx';
import ZeroRateMin from '/snippets/invoices/es/zero-rate.min.mdx';
import ZeroRate from '/snippets/invoices/es/zero-rate.mdx';
import ExemptMin from '/snippets/invoices/es/peppol-vf-exempt.min.mdx';
import Exempt from '/snippets/invoices/es/peppol-vf-exempt.mdx';
import ReverseChargeMin from '/snippets/invoices/es/peppol-vf-reverse-charge.min.mdx';
import ReverseCharge from '/snippets/invoices/es/peppol-vf-reverse-charge.mdx';
import IntraCommunityMin from '/snippets/invoices/es/peppol-vf-intra-community.min.mdx';
import IntraCommunity from '/snippets/invoices/es/peppol-vf-intra-community.mdx';
import OutsideScopeMin from '/snippets/invoices/es/peppol-vf-outside-scope.min.mdx';
import OutsideScope from '/snippets/invoices/es/peppol-vf-outside-scope.mdx';
import ExportMin from '/snippets/invoices/es/peppol-vf-export.min.mdx';
import Export from '/snippets/invoices/es/peppol-vf-export.mdx';

<AccordionGroup>
  
  <Accordion title="B2B Standard invoice Spain">
  ...
  <Accordion title="B2B zero rated goods invoice Spain">
  ...
  <Accordion title="B2B exempt invoice Spain">
  ...
  <Accordion title="B2B services invoice Spain → EU customer (Reverse Charge)">
  ...
  <Accordion title="B2B goods invoice Spain → EU customer (Intra-Community)">
  ...
  <Accordion title="B2B services invoice Spain → international customer (Outside Scope)">
  ...
  <Accordion title="B2B goods invoice Spain → international customer (Export)">
