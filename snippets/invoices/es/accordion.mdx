...
import CorrectiveInvoiceMin from '/snippets/invoices/es/verifactu-corrective.min.mdx';
import ReplacementInvoice from '/snippets/invoices/es/verifactu-replacement.mdx';
