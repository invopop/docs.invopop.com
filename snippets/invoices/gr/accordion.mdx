...
<AccordionGroup>
	...
	<Accordion title="Example credit note (B2B)">
		...
		- the line items carry the same [`gr-mydata-income-cat`](https://docs.gobl.org/addons/gr-mydata-v1#income-category) and [`gr-mydata-income-type`](https://docs.gobl.org/addons/gr-mydata-v1#income-type) extensions as the original, describing the amounts being credited, and,
		- there are no totals or calculations; all these will be made automatically when uploading.
