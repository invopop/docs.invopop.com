import B2BServicesInvoiceMin from '/snippets/invoices/gr/iapr-b2b-services.min.mdx';
import B2BServicesInvoice from '/snippets/invoices/gr/iapr-b2b-services.mdx';
import B2CGoodsInvoiceMin from '/snippets/invoices/gr/iapr-b2c-goods.min.mdx';
import B2CGoodsInvoice from '/snippets/invoices/gr/iapr-b2c-goods.mdx';
import B2CAccommodationClimateInvoiceMin from '/snippets/invoices/gr/iapr-b2c-accommodation-climate.min.mdx';
import B2CAccommodationClimateInvoice from '/snippets/invoices/gr/iapr-b2c-accommodation-climate.mdx';
import B2BClimateFeeInvoiceMin from '/snippets/invoices/gr/iapr-b2b-climate-fee.min.mdx';
import B2BClimateFeeInvoice from '/snippets/invoices/gr/iapr-b2b-climate-fee.mdx';
import CreditNoteMin from '/snippets/invoices/gr/iapr-credit-note.min.mdx';
import CreditNote from '/snippets/invoices/gr/iapr-credit-note.mdx';
import BranchInvoiceMin from '/snippets/invoices/gr/iapr-branch.min.mdx';
import BranchInvoice from '/snippets/invoices/gr/iapr-branch.mdx';
...
<AccordionGroup>
	...
	<Accordion title="Example accommodation + climate fee invoice (B2C)">
		...
		<CodeGroup>
			<B2CAccommodationClimateInvoiceMin />
			<B2CAccommodationClimateInvoice />
		</CodeGroup>
	</Accordion>
	...
	<Accordion title="Example invoice issued from a branch (B2B)">

		In this example, the supplier issues the invoice from one of its branches instead of the headquarters.

		Notice:

		- we've set the [`gr-mydata-branch`](https://docs.gobl.org/addons/gr-mydata-v1#branch-number) extension on the supplier to `2`; this is the establishment number declared in the AADE taxpayer registry, and it becomes the issuer's `branch` in myDATA,
		- the customer also carries the extension (`1`) to report the receiving branch; when either party has no extension, branch `0` (headquarters) is reported, and,
		- the value must match an establishment declared for the party in the AADE registry.
