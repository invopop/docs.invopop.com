...
import B2GInvoiceMin from '/snippets/invoices/it/sdi-b2g.min.mdx';
import B2GInvoice from '/snippets/invoices/it/sdi-b2g.mdx';
import StampDutyInvoiceMin from '/snippets/invoices/it/sdi-stamp-duty.min.mdx';
import StampDutyInvoice from '/snippets/invoices/it/sdi-stamp-duty.mdx';
...
<AccordionGroup>
	...
	- The customer tax_id for a PA entity is the Codice Fiscale (11 digits for the example _Comune di Roma_).
