import StandardMin from '/snippets/invoices/it/peppol-standard.min.mdx';
import Standard from '/snippets/invoices/it/peppol-standard.mdx';
import ZeroRateMin from '/snippets/invoices/it/peppol-zero-rate.min.mdx';
import ZeroRate from '/snippets/invoices/it/peppol-zero-rate.mdx';
import ExemptMin from '/snippets/invoices/it/peppol-exempt.min.mdx';
import Exempt from '/snippets/invoices/it/peppol-exempt.mdx';
import ReverseChargeMin from '/snippets/invoices/it/peppol-reverse-charge.min.mdx';
import ReverseCharge from '/snippets/invoices/it/peppol-reverse-charge.mdx';
import IntraCommunityMin from '/snippets/invoices/it/peppol-intra-community.min.mdx';
import IntraCommunity from '/snippets/invoices/it/peppol-intra-community.mdx';
import OutsideScopeMin from '/snippets/invoices/it/peppol-outside-scope.min.mdx';
import OutsideScope from '/snippets/invoices/it/peppol-outside-scope.mdx';
import ExportMin from '/snippets/invoices/it/peppol-export.min.mdx';
import Export from '/snippets/invoices/it/peppol-export.mdx';
