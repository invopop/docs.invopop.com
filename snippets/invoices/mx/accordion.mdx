...
<AccordionGroup>
	<Accordion title="B2B invoice (Personas Morales)">
		...
		- the built version in the second tab shows the normalized document with calculated totals, line item sums, tax breakdowns (IVA), and automatically generated fields, and,
	...
	<Accordion title="B2B Invoice on behalf of a third party (a cuenta de terceros)">
		...
		- the minimal version in the first tab includes a `seller` on the line with RFC, fiscal regime, and postal code for the party actually selling,
		...
		- the built version in the second tab shows the normalized invoice with the third-party seller preserved on the line and full tax breakdown, and,
