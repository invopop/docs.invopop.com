import StandardMin from '/snippets/invoices/be/peppol-standard.min.mdx';
import Standard from '/snippets/invoices/be/peppol-standard.mdx';
import ZeroRateMin from '/snippets/invoices/be/peppol-zero-rate.min.mdx';
import ZeroRate from '/snippets/invoices/be/peppol-zero-rate.mdx';
import ExemptMin from '/snippets/invoices/be/peppol-exempt.min.mdx';
import Exempt from '/snippets/invoices/be/peppol-exempt.mdx';
import ReverseChargeMin from '/snippets/invoices/be/peppol-reverse-charge.min.mdx';
import ReverseCharge from '/snippets/invoices/be/peppol-reverse-charge.mdx';
import IntraCommunityMin from '/snippets/invoices/be/peppol-intra-community.min.mdx';
import IntraCommunity from '/snippets/invoices/be/peppol-intra-community.mdx';
import OutsideScopeMin from '/snippets/invoices/be/peppol-outside-scope.min.mdx';
import OutsideScope from '/snippets/invoices/be/peppol-outside-scope.mdx';
import ExportMin from '/snippets/invoices/be/peppol-export.min.mdx';
import Export from '/snippets/invoices/be/peppol-export.mdx';
import CreditNoteMin from '/snippets/invoices/be/peppol-credit-note.min.mdx';
import CreditNote from '/snippets/invoices/be/peppol-credit-note.mdx';
...
<AccordionGroup>
  ...
  <Accordion title="Peppol Belgium - B2B credit note">
