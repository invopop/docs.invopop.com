import StandardMin from '/snippets/invoices/fr/peppol-standard.min.mdx';
import Standard from '/snippets/invoices/fr/peppol-standard.mdx';
import ZeroRateMin from '/snippets/invoices/fr/peppol-zero-rate.min.mdx';
import ZeroRate from '/snippets/invoices/fr/peppol-zero-rate.mdx';
import ExemptMin from '/snippets/invoices/fr/peppol-exempt.min.mdx';
import Exempt from '/snippets/invoices/fr/peppol-exempt.mdx';
import ReverseChargeMin from '/snippets/invoices/fr/peppol-reverse-charge.min.mdx';
import ReverseCharge from '/snippets/invoices/fr/peppol-reverse-charge.mdx';
import IntraCommunityMin from '/snippets/invoices/fr/peppol-intra-community.min.mdx';
import IntraCommunity from '/snippets/invoices/fr/peppol-intra-community.mdx';
import OutsideScopeMin from '/snippets/invoices/fr/peppol-outside-scope.min.mdx';
import OutsideScope from '/snippets/invoices/fr/peppol-outside-scope.mdx';
import ExportMin from '/snippets/invoices/fr/peppol-export.min.mdx';
import Export from '/snippets/invoices/fr/peppol-export.mdx';
...
<AccordionGroup>
  ...
  <Accordion title="B2B zero rated goods invoice France">
    ...
    To create a zero-rated invoice, use the tax key `zero` in your invoice lines. The [`eu-en16931-v2017`](https://docs.gobl.org/addons/eu-en16931-v2017) addon will automatically set the UNTDID 5305 tax category to `Z` (zero rated goods) when the silo entry is built.
