...
import SimplifiedInvoiceMin from '/snippets/invoices/pt/at-simplified.min.mdx';
import SimplifiedInvoice from '/snippets/invoices/pt/at-simplified.mdx';
...
<AccordionGroup>
	...
	<Accordion title="AT simplified invoice">
		...
		In this example, we're issuing a simplified invoice (_Fatura Simplificada_) — the short-form invoice used for low-value retail sales where the customer doesn't need to be identified.
