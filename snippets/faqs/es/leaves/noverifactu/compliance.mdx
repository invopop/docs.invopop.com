  ...
  <Accordion title="Are there special supplier obligations under No-VERI*FACTU?">
    Same fiscal residence requirements as VERI\*FACTU. Additionally, the supplier must be able to produce the chained register on AEAT request; Invopop retains it on their behalf for the legally required period.
  </Accordion>
