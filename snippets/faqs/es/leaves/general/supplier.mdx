...
import Autonomo from '/snippets/parties/es/supplier-autonomo.mdx';
  ...
  <Accordion title="What are the most common reasons for failing supplier approval?">
    ...
    - Users upload a handwritten signature without an ID.
  ...
  <Accordion title="What is the minimum information required to register a supplier?">
    ...
    **Legal representative**
    ...
    If the entity is a self-employed individual (_autónomo_), only the information requested in the **Legal representative** section is required.
