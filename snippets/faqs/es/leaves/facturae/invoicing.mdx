  ...
  <Accordion title="Is the Facturae invoice reported to the tax authority?">
    No — the Facturae app only converts GOBL to Facturae XML. Submit B2G invoices via [FACe](https://face.gob.es/es); tax reporting to the AEAT happens separately (e.g. through SII or VERI\*FACTU).
  </Accordion>
