  ...
  <Accordion title="Is VERI*FACTU compliance mandatory in Spain?">
    VERI\*FACTU will be mandatory for companies from January 1st, 2027. The rest of taxpayers (mainly self-employed individuals) from 1 July 2027. Companies reporting with SII (large companies) or TicketBAI are exempt from reporting with VERI\*FACTU.
  </Accordion>
