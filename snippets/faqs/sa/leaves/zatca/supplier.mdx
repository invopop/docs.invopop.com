<Accordion title="What do I need to onboard a party with ZATCA?">
  ...
  During the hosted onboarding wizard the supplier also provides the legal name, invoice type (`1000` standard / `0100` simplified / `1100` both), branch name, and business category — plus the FATOORA OTP. The registered address is derived from the party’s national address.
</Accordion>
