  ...
  <Accordion title="What invoice types are supported in Argentina?">
    ...
    Invopop supports all of these invoice types through the Argentina app, except Factura E, which is coming soon.
  </Accordion>
  ...
  <Accordion title="What is required to issue invoices under ARCA?">
    The supplier party (issuer) must have an active CUIT, a Clave Fiscal at security level 3 or higher, and a valid ARCA digital certificate generated specifically for electronic invoicing (separate from the one used for AFIP web access).
  </Accordion>
