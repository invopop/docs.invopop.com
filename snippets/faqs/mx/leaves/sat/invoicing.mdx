  ...
  <Accordion title="I'm getting the error 'Access denied, supplier XXX is not registered in this workspace'. What should I do?">
    ...
    To fix it, make sure the supplier is correctly registered by following the [Register a supplier](/guides/mx-sat-issuing#register-a-supplier) steps in this guide.
