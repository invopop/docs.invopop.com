...
| Pago    | `P` |  Payment receipt (REP) issued when collecting against a previously-issued PPD invoice. | Coming soon |
...
<AccordionGroup>
  ...
  <Accordion title="Pago (payment receipt)">
    ...
    **Invopop coverage:** Invopop allows issuing invoices marked as PPD, but does not currently generate the subsequent payment receipts. Customers issuing PPD invoices through Invopop must produce REPs through another mechanism. Support for _complementos de pago_ is coming soon.
  </Accordion>
