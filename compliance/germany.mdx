...
<Columns cols="2">
  <Card title="OASIS UBL" icon="https://assets.invopop.com/apps/ubl/logo.svg" href="/apps/app-oasis-ubl" horizontal>Get covered →</Card>
  <Card title="ZUGFeRD" icon="https://assets.invopop.com/apps/xinvoice/icon.svg" href="/apps/app-zugferd" horizontal>Get covered →</Card>
</Columns>
