...
|    |    |
|-----------|------------|
|  Compliance |  🇩🇪&nbsp;&nbsp;Germany compliance (you're here) <br /> <Icon icon="timeline" /> [Compliance timeline](/timelines/germany)|
...
|  GOBL | <Icon icon="https://assets.invopop.com/icons/gobl.svg" />  [Germany Tax Regime](https://docs.gobl.org/regimes/de) |
