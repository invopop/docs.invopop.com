...
sequenceDiagram
    ...
    alt Buyer is regustered on Peppol
...
<Steps>
  ...
  <Step title="Generate the e-invoice">
    Invopop produces the appropiate XML document (Peppol BIS 3, TEAPPSXML or Finvoice).
  </Step>
  ...
  <Step title="Domestic-registered buyers">
    If the buyer is not on Peppol, Invopop routes the invoice to a Finnish banks or operator networks, delivered as Finvoice or TEAPPSXML.
  </Step>
</Steps>
