...
<Columns cols="2">
  <Card title="SDI Italy" size="20" icon="https://assets.invopop.com/apps/sdi-italy/icon.svg" href="/apps/sdi-italy" horizontal>Get covered →</Card>
  <Card title="Smart Receipts Italy" size="20" icon="https://assets.invopop.com/apps/agenzia-entrate/icon.svg" href="/apps/smart-receipts-italy" horizontal>Get covered →</Card>
</Columns>
