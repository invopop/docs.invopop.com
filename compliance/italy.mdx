...
<Columns cols="2">
  <Card title="SDI Italy" size="20" icon="https://assets.invopop.com/apps/sdi-italy/icon.svg" href="/apps/it-sdi" horizontal>Get covered →</Card>
  <Card title="Smart Receipts Italy" size="20" icon="https://assets.invopop.com/apps/agenzia-entrate/icon.svg" href="/apps/it-smart-receipts" horizontal>Get covered →</Card>
</Columns>

**Invopop integrations** to issue compliant FatturaPA and _Documento Commerciale_ invoices from your merchant or ERP platform:
...
<AccordionGroup>
  <Accordion title="FatturaPA (B2B and B2G)">
    ...
    | **Invopop support** | [SDI Italy App](/apps/it-sdi) |

    <Card title="SDI Italy" icon="https://assets.invopop.com/apps/sdi-italy/icon.svg" href="/apps/it-sdi" horizontal>
  ...
  <Accordion title="Documento Commerciale (B2C)">
    ...
    | **Agency** | [Agenzia delle Entrate](https://www.agenziaentrate.gov.it) |
    | **Invopop support** | [Smart Receipts Italy App](/apps/it-smart-receipts) |

    <Card title="Smart Receipts Italy" icon="https://assets.invopop.com/apps/agenzia-entrate/icon.svg" href="/apps/it-smart-receipts" horizontal>
      Connect the app to get you covered →
    </Card>
  </Accordion>
</AccordionGroup>
