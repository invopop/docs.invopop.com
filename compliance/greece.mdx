...
sidebarTitle: "🇬🇷 Greece"
description: "Comprehensive guide to Greece's mandatory e-invoicing requirements, EN 16931 implementation, and myDATA e-reporting obligations for B2B, B2C, and B2G transactions"
--- 
...
|    |    |
|-----------|------------|
|  Compliance |  🇬🇷&nbsp;&nbsp;Greece compliance (you're here) <br /> <Icon icon="timeline" /> [Compliance timeline](/timelines/greece)|
...
|  GOBL | <Icon icon="https://assets.invopop.com/icons/gobl.svg" />  [Greece Tax Regime](https://docs.gobl.org/regimes/gr) |
