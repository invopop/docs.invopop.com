...
description: "Comprehensive guide to Portugal's mandatory e-invoicing requirements, ATCUD/QR implementation, and SAF-T e-reporting obligations for B2B and B2G transactions"
---
...
<AccordionGroup>
  <Accordion title="ATCUD/QR (B2B, B2G)">
...
<AccordionGroup>
  ...
  <Accordion title="What are the QR code requirements for ATCUD/QR?">
