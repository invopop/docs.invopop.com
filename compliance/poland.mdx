...
description: "Poland's mandatory e-invoicing requirements, KSeF implementation, and e-reporting obligations for B2B and B2G transactions"
---

import PolandResources from '/snippets/tables/poland-resources.mdx';
import ComplianceFAQ from '/snippets/faqs/pl/composers/page-compliance.mdx';
...
To improve adoption, KSeF offers multiple issuance channels including the [e-Faktur](https://ap.ksef.mf.gov.pl) web portal, a dedicated API for ERP integration, and an official mobile app. QR codes and a 24-hour offline mode have also been developed for easy verification and to maintain functionality during temporary network outages.
...
<AccordionGroup>
  <Accordion title="KSeF (B2G, B2B)">
    ...
    | **Invopop support**  | [Poland App](/apps/poland)                                           |
  </Accordion>
</AccordionGroup>
