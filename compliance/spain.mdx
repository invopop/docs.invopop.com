...
<AccordionGroup>
  <Accordion title="TicketBAI (B2C, B2B, B2G)">
    ...
    | **Invopop support** | [Spain App](/apps/spain) (TicketBAI) |

    <Card title="TicketBAI (Spain app)" size="20" icon="https://assets.invopop.com/apps/ticketbai/icon.svg" href="/apps/spain" horizontal>
      Connect the app to get you covered →
    </Card>
