...
<Columns cols="2">
  <Card title="VERI*FACTU Spain" size="20" icon="https://assets.invopop.com/apps/verifactu/icon.svg" href="/apps/es-verifactu" horizontal>Get covered →</Card>
  <Card title="TicketBAI Spain" icon="https://assets.invopop.com/apps/ticketbai/icon.svg" href="/apps/es-ticketbai" horizontal>Get covered →</Card>
  <Card title="Facturae Spain" icon="https://assets.invopop.com/apps/facturae/icon.svg" href="/apps/es-facturae" horizontal>Get covered →</Card>
