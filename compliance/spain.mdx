...
<Warning>
The VERI\*FACTU mandate is expected to be postponed by one year following the publication of [The Royal Decree](https://www.boe.es/boe/dias/2025/12/03/pdfs/BOE-A-2025-24446.pdf). However, the postponement requires approval from Congress before becoming official. This article will be updated once the postponement is officially confirmed.
</Warning>
...
[VERI\*FACTU](#veri-factu-b2b) is already available and will become mandatory for all invoices starting January 1, 2026, except for companies already reporting via SII or TicketBAI. It requires digitally signed invoices, a QR code linking to AEAT verification. 
...
<AccordionGroup>
  <Accordion title="VERI*FACTU (B2C, B2B, B2G)">
    ...
    Spain’s upcoming e-reporting and fiscalization regulation requiring businesses to use approved software that records and digitally signs each invoice to ensure transparency and prevent fraud.
    ...
    | **Effective date** | Mandatory for businesses issuing B2C, B2B, B2G invoices from **Jan 1, 2026** |
