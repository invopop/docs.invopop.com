...
[VERI\*FACTU](#veri-factu-b2b) will become mandatory for all B2B invoices starting January 1, 2027, except for companies already reporting via SII or TicketBAI. It requires digitally signed invoices, a QR code linking to AEAT verification. 
