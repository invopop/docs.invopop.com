  ...
  * If any of the following apply, it must be mentioned: tax-exempt transaction, customer issues the invoice, reverse charge (customer pays the tax), Travel Agency special scheme, or second-hand goods special scheme.
  ...
  <Accordion title="Main special tax types for Spain">
    ...
    3. IRPF Rates (Personal Income Tax)
      ...
      * Modules Rate: 1%
    4. IRNR (Non-residents Income Tax)
      * Retained tax category for income obtained in Spanish territory by individuals and entities not resident in Spain, without a permanent establishment.
      * Regulated by Real Decreto Legislativo 5/2004 (TRLIRNR).
      * The Spanish payer is generally obliged to withhold the tax at source on each payment.
      * Rates depend on the type of income and whether the recipient is resident in an EU/EEA Member State with an effective exchange of tax information (reduced rates may apply).
