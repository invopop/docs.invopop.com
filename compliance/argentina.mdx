...
E-reporting in Argentina is fully integrated into the electronic invoicing system — see [E-reporting](#e-reporting) below.
...
<AccordionGroup>
  ...
  <Accordion title="Legally required invoice content">
    ...
    - **CAE (Código de Autorización Electrónico)**: 14-digit authorization code from ARCA
