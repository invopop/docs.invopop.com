...
|  |  |
|------|------------|
| **AMS** | Adresar metapodatkovnih servisa, the national directory that tells a sender's access point where a recipient receives e-invoices |
...
| **FINA** | Financijska agencija, the state agency that runs the central platform where public bodies receive e-invoices (e-Račun za državu), including its Peppol access point |
| **Fiscalization 2.0** | Croatia's framework, mandatory since January 2026, that combines structured e-invoice exchange over a 4-corner network with reporting of each invoice to CIS (see [Croatia compliance](/compliance/croatia)) |
