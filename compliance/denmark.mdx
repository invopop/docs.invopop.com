...
<AccordionGroup>
  <Accordion title="🇩🇰 Invopop resources for Denmark">
    |            |                                                                                                                                                       |
    | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
    | Compliance | <Icon icon="https://assets.invopop.com/flags/dk.svg" /> [Invoicing compliance in Denmark](/compliance/denmark)<br /> <Icon icon="timeline" /> [Compliance timeline](/timelines/dk) |
...
[NemHandel / PEPPOL](#nemhandel-peppol-b2g) is mandatory for all invoices to public authorities. It is the longest-standing B2G e-invoicing mandate in Europe, enforced since 2005.
