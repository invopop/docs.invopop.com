...
<AccordionGroup>
  ...
  <Accordion title="NFC-e (B2C)">
    ...
    | **Invopop Support** | [Documentos Fiscais Eletrônicos Brazil](/apps/documentos-fiscais-electronicos-brazil) |
      ...
      <Card title="Documentos Fiscais Eletrônicos Brazil" size="20" icon="https://assets.invopop.com/apps/notas-fiscais-eletronicas-brazil/icon.svg" href="/apps/br-notas-fiscais" horizontal>Get covered →</Card>
  </Accordion>
