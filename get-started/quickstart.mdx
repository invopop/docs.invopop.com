...
You may be prompted to log in again, and you'll be redirected to the Invopop Admin area.
  ...
  <Step title="Click on the 'Invite member' button on the top right corner">
    ...
    <Note>
      If your plan covers a single user, you'll need to add multi-user access to your subscription before you can invite colleagues — the Members page links to the relevant billing settings.
    </Note>
  </Step>
  <Step title="All done">
