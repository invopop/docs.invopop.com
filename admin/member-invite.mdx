...
<Note>
At the moment, we don't support role-based access control. All members have the same permissions, and every member in your organization will have access to all your workspaces. We're planning to implement workspace-level access control in the future.
</Note>
