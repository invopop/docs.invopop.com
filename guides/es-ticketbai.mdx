...
import { esTicketbaiInvoiceWorkflow } from '/snippets/workflows/es/ticketbai-invoice-data.mdx';
import { esTicketbaiCancelWorkflow } from '/snippets/workflows/es/ticketbai-cancel-data.mdx';
