...
<Steps>
  <Step title="Add a cancel invoice workflow (only once)">
    ...
    <Tabs>
      <Tab title="Template">
        <Card title="TicketBAI cancel invoice workflow" icon="code-branch" iconType="duotone" href="https://console.invopop.com/redirect/workflows/new?template=es-ticketbai-cancel" cta="Add to my workspace">
      ...
      <Tab title="Build from scratch">
        ...
        In [Console](https://console.invopop.com), create a new workflow and choose [Empty Invoice workflow](https://console.invopop.com/redirect/workflows/new?template=empty-invoice) as the base. Then name the workflow with a descriptive label such as "TicketBAI Cancel Invoice".
