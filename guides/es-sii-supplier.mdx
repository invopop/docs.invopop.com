...
import Supplier from '/snippets/suppliers/es/sii-essential.mdx';
...
<AccordionGroup>
  ...
  <Accordion title="What happens if a supplier validation is rejected?">
    ...
    1. Unregister the supplier using the [Unregister Supplier workflow](#template-3).
    ...
    <Frame caption="Overriding the previously submitted agreement">
      <img
        width="600"
        src="/assets/guides/es-sii-update-agreement.png"
