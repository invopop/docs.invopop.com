...
import SupplierRegistration from '/snippets/workflows/templates/es/sii-register-party.mdx';
...
<Steps>
 <Step title="Connect the Spain app">
  ...
  <Step title="Create a supplier registration workflow">
    ...
    <Tabs>
      <Tab title="Template">
        <Card title="SII supplier registration workflow" icon="code-branch" iconType="duotone" href="https://console.invopop.com/redirect/workflows/new?template=es-sii-register-party" cta="Add to my workspace">
