...
Navigate to **Configuration** → **Apps**, find the **Italy** app, tap **Configure**, and select the import workflow you just created. It will run automatically whenever an invoice arrives.
</Step>
