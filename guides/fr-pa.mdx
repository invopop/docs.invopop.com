...
Invopop is _Plataforme Agréée_ (Approved Platform) by the French tax administration, meaning we have successfully provided all necessary documentation for the registration procedure and passed the technical compliance verification.
...
French e-invoicing via PA platforms will become mandatory starting **September 2026**. While Invopop is already approved as a PDP platform, the service is not yet available as we continue developing and preparing for the mandatory implementation date.
