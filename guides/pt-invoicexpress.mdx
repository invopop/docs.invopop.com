...
| **Environment** | InvoiceXpress configured to use AT sandbox | Real AT |
| **Fiscal effect** | None; contact Invopop for setup | Yes |
...
<Card title="Participate in our community"
  ...
  horizontal
>
  Ask and answer questions about invoicing in Portugal →
</Card>
