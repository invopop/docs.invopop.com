...
<Tabs>
  ...
  <Tab title="Build from scratch">
      ...
      This is the minimal workflow with state handling required to issue invoices through SDI. You may expand it with additional steps such as storing a backup copy, notifying clients, or integrating the documents into an ERP system.
