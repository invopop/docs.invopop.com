...
import { itSdiPostRegistrationFlowWorkflow } from '/snippets/workflows/it/sdi-post-registration-flow-data.mdx';
import { itTicketRegisterSupplierWorkflow } from '/snippets/workflows/it/ticket-register-supplier-data.mdx';
...
<Card iconType="duotone" title="Smart Receipts supplier post-registration workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=ticket-post-registration" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={itSdiPostRegistrationFlowWorkflow} />
  </Tab>
  <Tab title="Code">
...
<Card iconType="duotone" title="Smart receipts supplier registration workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=ticket-register-supplier" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={itTicketRegisterSupplierWorkflow} />
  </Tab>
  <Tab title="Code">
    Copy and paste into a new [Empty Party workflow](https://console.invopop.com/redirect/workflows/new?template=empty-party) code view.
