...
import BelgiumInvoiceExamples from '/snippets/invoices/be/accordion.mdx';
...
<Tab title="France" icon="https://assets.invopop.com/flags/fr.svg">
  <FRPeppolSupplier />
</Tab>
...
<Tab title="Sweden" icon="https://assets.invopop.com/flags/se.svg">
  <SEPeppolSupplier />
</Tab>
</Tabs>
