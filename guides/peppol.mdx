...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Peppol issue invoice workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=peppol-send" cta="Add to my workspace">
      This workflow converts a [GOBL](https://docs.gobl.org) document into the Peppol format and sends it to the network
    </Card>
  </Tab>
  <Tab title="Code">
  ...
  <Tab title="Build from scratch">
    Use the [Console](https://console.invopop.com/) to build a [workflow](/guides/workflows) of the Invoice type. Include these essential steps:
...
<Tabs>
  ...
  <Tab title="Build from scratch">
      ...
      This workflow is composed of these steps:
