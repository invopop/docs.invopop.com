...
import SupplierRegistration, { frChorusProRegistrationWorkflow } from '/snippets/workflows/fr/chorus-pro-registration.mdx';
...
<Steps>
  <Step title="Create a Chorus Pro account">
    ...
    <Info>
      To test in sandbox mode, create an account in the [Chorus Pro sandbox](https://qualif.chorus-pro.gouv.fr/aife_qual). Download a CSV file with test accounts. Use one of the accounts to log in. Test accounts come with their own SIRET, so the supplier's tax ID has to be derived from it rather than taken from the real company — the [FAQ below](#faq) has a converter that does this for you. For more information, visit the [Chorus Pro documentation](https://portail.chorus-pro.gouv.fr/aife_documentation?sys_kb_id=8ea00d85c398ea1477c2530ed40131e2&id=kb_article_view&sysparm_rank=1&sysparm_tsqueryId=66f41ea033de625056688539bd5c7bd9).
    </Info>
  </Step>
