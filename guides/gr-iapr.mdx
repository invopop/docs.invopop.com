...
Don't hesitate to contact us via Slack or [support@invopop.com](mailto:support@invopop.com) whenever you need to onboard a new supplier. We will walk you through the setup process.
...
In this section, we'll show you how to register a supplier in Invopop and issue a service note on his behalf.
