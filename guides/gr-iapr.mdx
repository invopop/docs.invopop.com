...
- we've added the `gr-mydata-v1` addon; this ensures the document will be validated and normalized using the myDATA v1 rules built into the [GOBL](https://docs.gobl.org) library,
