...
<Steps>
  <Step title="Connect ILYDA Greece App">
    ...
    <Frame>
      <img
        src="/assets/guides/gr-iapr-app.png"
        width="400"
        alt="ILYDA Greece App"
      />
    </Frame>
    <Info>
  ...
  <Step title="Prepare Invoice Workflow">
    <Tabs>
      <Tab title="Template">
        <Card title="IAPR Invoice Workflow" icon="code-branch" iconType="duotone" href="https://console.invopop.com/redirect/workflows/new?template=gr-iapr-invoice" cta="Add to my workspace">
...
<Card title="Greece FAQ" icon="square-question" horizontal href="/faq/greece">
