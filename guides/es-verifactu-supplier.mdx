...
import UnregisterExample from '/snippets/workflows/es/verifactu-unregister.mdx';
import SupplierRegistration from '/snippets/workflows/es/verifactu-supplier-registration.mdx';
...
import { esVerifactuUnregisterWorkflow } from '/snippets/workflows/es/verifactu-unregister-data.mdx';
import { esVerifactuSupplierRegistrationWorkflow } from '/snippets/workflows/es/verifactu-supplier-registration-data.mdx';
