...
<Tabs>
  ...
  <Step title="Send your company to the registration workflow">
    ...
    Locate your company in the **Suppliers** section and tap on "Select Workflow". From the side panel, select the **VERI\*FACTU supplier registration workflow** you created in the [Setup](#set-up) section.
