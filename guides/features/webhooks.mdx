...
This guide will show you how to configure the Webhook workflow step to send HTTP requests automatically from your workflows. You can use webhooks to notify external systems, trigger automations, or synchronize data with third-party APIs whenever an event occurs.
...
Add the **Send Webhook** step to your workflow (or workflow condition) by searching or locating it in the actions list under the **Notify** section.

<Frame>
  <img
    width="399"
    src="/guides/images/webhooks-list.png"
...
<Frame>
  <img
    width="399"
    src="/guides/images/webhooks.png"
