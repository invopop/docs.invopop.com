...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Issue Peppol Invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=peppol-send" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Receive Peppol Document workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=peppol-receive" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="Supplier registration workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=peppol-register" cta="Select a workspace to use this template">
