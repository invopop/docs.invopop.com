...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Peppol issue invoice workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=peppol-send" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Peppol receive document workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=peppol-receive" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="Peppol supplier registration workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=peppol-register" cta="Select a workspace to use this template">
