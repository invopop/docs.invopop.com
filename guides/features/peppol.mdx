...
When registration is successful, you'll see the Peppol Participant ID in the Meta tab of the entry and the supplier's entry will contain `inboxes` array. This information should be included in each invoice issued by this supplier. 
