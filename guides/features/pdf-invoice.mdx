...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="PDF Invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=pdf-invoice" cta="Select a workspace to use this template">
