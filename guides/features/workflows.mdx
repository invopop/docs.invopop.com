...
While it is possible to create workflows via the API, we strongly recommend using the [Invopop Console](https://console.invopop.com) as the UI will help you correctly define and configure each of the different steps.
...
There are currently five document types:

- **Invoices** - sales or expenses.
- **Contacts** - suppliers or customers.
- **Payments** - payments or receipts.
- **Orders**
- **Deliveries**
