...
- [Empty Party workflow](https://console.invopop-staging.com/redirect/workflows/new?template=empty-party): for suppliers or customers.
...
Choose **Empty Invoice workflow** for this example and then click **Load Template**.
