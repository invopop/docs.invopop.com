...
<Frame >
<img src="/guides/images/workflow-anatomy.png" width="400" alt="Parts of a workflow" />
</Frame>
...
<img src="/guides/images/workflow-template-empty.png" width="400" alt="Parts of a workflow" className="rounded-lg" />
...
The "developer mode" <img src="/guides/images/workflow-switcher.png" width="50" alt="Developer mode switch" className="inline-block m-0" /> switch at the top right of the canvas can be used to display the JSON representation of the workflow. This makes it easy to copy and paste workflows from examples or other workspaces. Make sure to return to the visual editor view to ensure the document is validated.
...
<Steps>
  <Step title="Add a condition on the step">
    ...
    <Frame>
      <img src="/guides/images/workflow-add-condition.png" width="400" alt="Add condition" />
    </Frame>
  </Step>
  <Step title="Configure the condition">
    <Frame>
      <img src="/guides/images/workflow-add-condition-match.png" width="400" alt="Add match conditions" />
    </Frame>
  ...
  <Step title="Add an action to the condition block">
    <Frame>
      <img src="/guides/images/workflow-add-condition-action.png" width="400" alt="Add condition action" />
    </Frame>
