...
import { sendInvoiceWorkflow } from '/snippets/workflows/fr/fr-pa-send-invoice-data.mdx';
import { receiveInvoiceWorkflow } from '/snippets/workflows/fr/fr-pa-receive-invoice-data.mdx';
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={sendInvoiceWorkflow} />
  </Tab>
  <Tab title="Code">
    <SendInvoiceWorkflow />
  </Tab>
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={receiveInvoiceWorkflow} />
  </Tab>
  <Tab title="Code">
