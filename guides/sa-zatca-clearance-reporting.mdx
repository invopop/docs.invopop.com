...
Every invoice is rendered as **UBL 2.1 XML with ZATCA's KSA extensions**, regardless of flow. Before submission, Invopop adds the two chain values ZATCA requires:
