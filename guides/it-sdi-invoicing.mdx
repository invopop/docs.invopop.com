...
For receiving invoices through the same channel, see the companion guide: [Receiving invoices](/guides/it-sdi-reception). For preserving them, see [Archiving](/guides/it-sdi-archiving).
