...
<Warning>
  Certified archiving needs a real *partita IVA* or *codice fiscale* on both parties. If you archive the invoices you issue, collect one before issuing rather than relying on the filler values above.
</Warning>
