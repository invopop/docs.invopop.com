...
import WF_PDF_JSON from '/snippets/workflows/pdf/invoice.mdx';
...
<AccordionGroup>
  ...
  <Accordion title="Belgian invoice (fr)">
    ...
    <Frame caption="[View PDF](/assets/guides/pdf-portugal-pt.pdf)">
      <img src="/assets/guides/pdf-portugal-pt.png" width="400" alt="Example PDF invoice" />
    </Frame>
  </Accordion>
