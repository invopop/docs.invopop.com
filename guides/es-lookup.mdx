---
title: "AEAT tax ID lookup guide"
...
Validating a party’s Spanish tax ID before registering a supplier or issuing an invoice reduces rejections and data-entry errors. This guide shows how to add AEAT (Spanish Tax Agency) checks to your [workflows](/guides/workflows) so you can:
...
* [Verify tax IDs (NIF/CIF)](#verify-tax-ids-nifcif)
* [Verify & correct tax details](#verify--correct-tax-details)
