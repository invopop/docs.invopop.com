...
When your customer opens the registration link, ARCA guides them through a wizard to create a certificate and upload it to Invopop.

The steps differ between sandbox and production. Share the Spanish guides below with the customer who will complete the wizard:

- **Sandbox**: [ARCA certificate wizard (sandbox)](/guides/ar-certificates-sandbox)
- **Production**: [ARCA certificate wizard (production)](/guides/ar-certificates-production)
...
**Sandbox environment**: You can use any point of sale number after the registration process is complete and your certificate is uploaded.
