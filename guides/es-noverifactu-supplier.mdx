...
import { esNoverifactuSupplierRegistrationWorkflow } from '/snippets/workflows/es/noverifactu-supplier-registration-data.mdx';
import { esNoverifactuUnregisterWorkflow } from '/snippets/workflows/es/noverifactu-unregister-data.mdx';
import { esNoverifactuEventWorkflow } from '/snippets/workflows/es/noverifactu-event-data.mdx';
import { esNoverifactuSummaryEventWorkflow } from '/snippets/workflows/es/noverifactu-summary-event-data.mdx';
