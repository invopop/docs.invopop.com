...
import SupplierRegistration, { esNoverifactuSupplierRegistrationWorkflow } from '/snippets/workflows/es/noverifactu-supplier-registration.mdx';
import UnregisterExample, { esNoverifactuUnregisterWorkflow } from '/snippets/workflows/es/noverifactu-unregister.mdx';
import EventWorkflow, { esNoverifactuEventWorkflow } from '/snippets/workflows/es/noverifactu-event.mdx';
import SummaryEventWorkflow, { esNoverifactuSummaryEventWorkflow } from '/snippets/workflows/es/noverifactu-summary-event.mdx';
