...
import { mxSatPlatformsRegisterWorkflow } from '/snippets/workflows/mx/sat-platforms-register-data.mdx';
import { mxSatPlatformsRecordWorkflow } from '/snippets/workflows/mx/sat-platforms-record-data.mdx';
import { mxSatPlatformsUnregisterWorkflow } from '/snippets/workflows/mx/sat-platforms-unregister-data.mdx';
