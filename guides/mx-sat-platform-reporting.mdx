...
import RegisterWorkflow, { mxSatPlatformsRegisterWorkflow } from '/snippets/workflows/mx/sat-platforms-register.mdx';
import RecordWorkflow, { mxSatPlatformsRecordWorkflow } from '/snippets/workflows/mx/sat-platforms-record.mdx';
import UnregisterWorkflow, { mxSatPlatformsUnregisterWorkflow } from '/snippets/workflows/mx/sat-platforms-unregister.mdx';
...
<Card iconType="duotone" title="SAT register platform workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=mx-sat-platforms-register" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={mxSatPlatformsRegisterWorkflow} />
  </Tab>
  <Tab title="Code">
...
<Card iconType="duotone" title="SAT record operation workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=mx-sat-platforms-record" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={mxSatPlatformsRecordWorkflow} />
  </Tab>
  <Tab title="Code">
...
<Card iconType="duotone" title="SAT unregister platform workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=mx-sat-platforms-unregister" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={mxSatPlatformsUnregisterWorkflow} />
  </Tab>
  <Tab title="Code">
    Copy and paste into a new [Empty Party workflow](https://console.invopop.com/redirect/workflows/new?template=empty-party) code view.
    <UnregisterWorkflow />
