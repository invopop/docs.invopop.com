...
import CustomerRegistrationWorkflow, { itSdiRegisterCustomerWorkflow } from '/snippets/workflows/it/sdi-register-customer.mdx';
import CustomerUnregistrationWorkflow, { itSdiUnregisterCustomerWorkflow } from '/snippets/workflows/it/sdi-unregister-customer.mdx';
import ImportInvoicesWorkflow, { itSdiImportInvoicesWorkflow } from '/snippets/workflows/it/sdi-import-invoices.mdx';
...
<Warning>
**The SDI Italy app is being retired.** New integrations should use the [Italy app](/apps/italy), which reaches SDI through Invopop's own accredited channel. See the [receiving invoices](/guides/it-sdi-reception) guide.
</Warning>
...
<Accordion title="Italian customer example">
