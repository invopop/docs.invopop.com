...
The email body textarea is where you compose your message's main content. This field allows for multiple paragraphs and template variables, as well as markdown formatted content.
