...
<Step title="Click on 'New Workflow'">
...
Add the first step to your new workflow by selecting an action on the sidebar. You can add more steps by clicking on the **+** button. Some steps will require configuration in order to function correctly.
