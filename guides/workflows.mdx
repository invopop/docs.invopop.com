...
**Exceptions** create blocks that execute when a `KO` es returned from a workflow step, and has an optional _code_ to further narrow down the exception condition.
