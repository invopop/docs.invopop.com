...
|---|---|---|---|
| Cancellation reason | `nfe-br-cancel-reason` | NFS-e and NFC-e | Free-text reason for the cancellation. For NFC-e, must be at least 15 characters if provided. Defaults to the system default when omitted. |
