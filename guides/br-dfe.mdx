...
- We've added the `br-nfse-v1` addon; this ensures the document will be validated using the NFS-e rules built into the [GOBL](https://docs.gobl.org) library.
...
- We've added the `br-nfe-v1` addon; this ensures the document will be validated using the NF-e/NFC-e rules built into the [GOBL](https://docs.gobl.org) library.
...
<Card title="Brazil FAQ"
  ...
  horizontal
>
  Find answers to frequently asked questions about invoicing in Brazil →
</Card>
