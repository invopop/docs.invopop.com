...
import { esNoverifactuInvoiceWorkflow } from '/snippets/workflows/es/noverifactu-invoice-data.mdx';
import { esNoverifactuCancelWorkflow } from '/snippets/workflows/es/noverifactu-cancel-data.mdx';
...
<Card title="NO VERI*FACTU invoice workflow" icon="code-branch" iconType="duotone" href="https://console.invopop.com/redirect/workflows/new?template=es-noverifactu-invoice" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={esNoverifactuInvoiceWorkflow} />
  </Tab>
  <Tab title="Code">
...
<Steps>
  <Step title="Add a cancel invoice workflow (only once)">
    ...
    <Card title="NO VERI*FACTU cancel invoice workflow" icon="code-branch" iconType="duotone" href="https://console.invopop.com/redirect/workflows/new?template=es-noverifactu-cancel" horizontal>
      Add to my workspace →
    </Card>
    <Tabs>
      <Tab title="Workflow">
        <WorkflowDiagram workflow={esNoverifactuCancelWorkflow} />
      </Tab>
      <Tab title="Code">
        Copy and paste into a new [Empty Invoice workflow](https://console.invopop.com/redirect/workflows/new?template=empty-invoice) code view.
