...
import WorkflowExample, { esNoverifactuInvoiceWorkflow } from '/snippets/workflows/es/noverifactu-invoice.mdx';
import CancelInvoice, { esNoverifactuCancelWorkflow } from '/snippets/workflows/es/noverifactu-cancel.mdx';
