...
<Steps>
  <Step title="Create Supplier post-registration workflow (optional)">
    ...
    <Frame>
      <img alt="New Contacts Workflow" width="350px" src="/guides/images/mx-sat-new-workflow.png" />
    </Frame>
...
<Frame>
  <img src="/guides/images/mx-sat-reg-link.png" width="450px" alt="Supplier Registration Link" />
</Frame>
