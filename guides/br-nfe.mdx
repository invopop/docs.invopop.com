---
title: "Brazil - NFS-e"
description: Issue NFS-e in Brazil via PlugNotas
---
...
Invopop partners with [PlugNotas](https://plugnotas.com.br) to provide a unified way to issue NFS-e documents across multiple municipalities from GOBL documents.
...
<Frame>
  <img src="/guides/images/br-nfe-app.png" width="400px" alt="SAT MX App" />
</Frame>
...
The details from this form are sent securely to PlugNotas, who will use them to authenticate in the corresponding municipality API.
