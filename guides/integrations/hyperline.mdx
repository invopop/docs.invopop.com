...
title: "Hyperline"
icon: "plug"
description: "Import and process invoices and credit notes from Hyperline"
---

import WorkflowExample from '/snippets/workflows/templates/hyperline/hyp-invoice.mdx'

## Introduction

[Hyperline](https://www.hyperline.co/) s a billing and revenue management platform for B2B SaaS companies that automates quotes, subscriptions, usage-based billing, and invoicing.

Invopop's Hyperline app lets you issue locally compliant electronic invoices and credit notes from Hyperline.

## How it works

The Invopop Hyperline app will subscribe to new incoming invoices and credit notes. When a new document is received, it'll be _converted_ into GOBL, and stored in your Invopop workspace.

Once an invoice or credit note is stored, the app will create a job on the configured workflow.

## Setup

This guide assumes that you already have a Hyperline site configured.

<Steps>
  <Step title="Prepare a Workflow">
    <Tabs>
      <Tab title="Template">
        <Card title="Hyperline Basic PDF workflow" icon="code-branch" iconType="duotone" href="https://console.invopop.com/redirect/workflows/new?template=hyperline-hyp-invoice" cta="Add to my workspace">
          This workflow syncs with Hyperline and generates a basic PDF.
        </Card>
      </Tab>
      <Tab title="Code">
