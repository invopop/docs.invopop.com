...
Next, Stripe will prompt you to select the Stripe environment you'd like to connect to, you can start with test mode and switch to live later.
...
<Note>
This step is automatically skipped if you have only one workspace.
</Note>
...
1. Select it in the Stripe's sidebar menu
2. Click **Save Workflow**

To create a new workflow:
1. Click **Create New Workflow** in the sidebar menu. You'll be redirected to Invopop.
2. Select **Create New Workflow** on the top right.
3. Select **Invoices** workflow type. 
4. Configure the workflow according to your local regulations. You can copy _the Basic PDF workflow_ example below and modify it later for your local needs.
5. Add the **Import data from Stripe** step as the first step of the workflow.

<Frame caption="Select your processing workflow">
...
Copy and paste the JSON below while editing a Workflow in "developer" mode.
<WorkflowExample />
</Accordion>
<Accordion title="Example Workflow - VeriFactu">

This workflow demonstrates integration with country-specific functionality. 
Copy and paste the JSON below while editing a Workflow in "developer" mode. 
<VerifactuExample />
</Accordion>
</AccordionGroup>
...
2. Go to [Stripe app settings](https://dashboard.stripe.com/settings/apps/com.invoicing.invopop)
3. Select a different workflow
