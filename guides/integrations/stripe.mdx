...
<AccordionGroup>
  ...
  Yes. Change the Stripe app’s import trigger in Invopop:
  1. Go to **Configuration** > **Apps** > **Stripe** > **Configure**.
  2. Click **Update Settings**.
  3. In the `Invoice import trigger` field, select "When Paid" (instead of "When Finalized").
  4. Click **Save**.
  ...
  This applies to new invoices going forward.
