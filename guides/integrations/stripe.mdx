...
<Tab title="Template">
    ...
    <CardGroup cols="1">
      <Card iconType="duotone" title="Stripe - VERI*FACTU invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=es-verifactu-invoice" cta="Select a workspace to use this template">
      This workflow will sync with Stripe to issue a VERI*\FACTU invoice on finalized sales.
      </Card>
      <Card iconType="duotone" title="Stripe - Basic PDF invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=es-verifactu-invoice" cta="Select a workspace to use this template">
