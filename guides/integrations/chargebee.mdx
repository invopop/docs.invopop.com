...
<Tabs>
  <Tab title="Template">
      <Card iconType="duotone" title="ChargeBee Basic PDF workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=chargebee-cb-invoice" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
      <Card iconType="duotone" title="ChargeBee ZUGfERD" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=chargebee-cb-xrechnung" cta="Select a workspace to use this template">
