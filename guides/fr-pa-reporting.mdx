...
Reporting is configured at the **SIREN level**, separately from the [party registration workflow](/guides/fr-pa-registration). When you enable reporting for a SIREN, two things are captured and reused for every report submitted afterwards:
