...
import { reportingSendWorkflow } from '/snippets/workflows/fr/fr-reporting-send-data.mdx';
import { reportingRecordWorkflow } from '/snippets/workflows/fr/fr-reporting-record-data.mdx';
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={reportingRecordWorkflow} />
  </Tab>
  <Tab title="Code">
    <RecordWorkflow />
  </Tab>
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={reportingSendWorkflow} />
  </Tab>
  <Tab title="Code">
    <SendWorkflow />
  </Tab>
