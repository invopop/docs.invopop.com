...
If you have a single supplier, or all your suppliers have the same cadence, you can configure the **Register party for reporting** step in the [PPF register supplier workflow](#ppf-register-supplier-workflow) to a specific cadence.
