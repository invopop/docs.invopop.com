...
- You can unrecord at any time until the window's filing deadline, even if a report XML was already generated — the report is regenerated without the document before it is sent. This also covers reports the PPF rejected.
- Once the report was submitted to the PPF, the document can no longer be unrecorded: corrections from that point go through a corrective filing.
