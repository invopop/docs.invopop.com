...
icon: "https://assets.invopop.com/apps/slack/icon.svg"
---
...
You need a Slack account with full membership or an admin role within a workspace.
...
<Steps>
  ...
  <Step title="Verify the connection">
    ...
    1. Navigate to the Invoices (or Parties) section and select the silo entry you want to run the workflow on.
