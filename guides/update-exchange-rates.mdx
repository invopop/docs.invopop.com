---
title: "Update exchange rates guide"
sidebarTitle: "Update exchange rates"
...
## Example
Imagine you created an invoice in USD and you need to convert it to EUR for reporting purposes. At first, the invoice's `exchange_rates` entry may be missing or contain a placeholder `amount`, like this:
...
<Accordion title="What happens if a currency in the exchange rates is not supported by the European Central Bank (ECB)?">
  If any of the currencies in the `exchange_rates` field isn't supported by the European Central Bank (ECB), the system will skip updating the exchange rate for that currency. No error will be thrown, and the process will continue.
...
### Support
We're always working to improve our features! If you require support for more banks for specific currencies or need any help, feel free to contact us at ([support](mailto:support@invopop.com)).
...
- [Invopop Workflow Configuration Guide](/guides/workflows)
