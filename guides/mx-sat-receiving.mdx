...
import ConvertCFDI from '/snippets/workflows/mx/sat-convert-cfdi.mdx';
import ImportCFDI from '/snippets/workflows/mx/sw-sapien-import-cfdi.mdx';
import RegisterParty from '/snippets/workflows/mx/sw-sapien-register-party.mdx';
import SubscribeImport from '/snippets/workflows/mx/mx-subscribe-import.mdx';
import Party from '/snippets/parties/mx/supplier.mdx';
...
import { mxSatConvertCfdiWorkflow } from '/snippets/workflows/mx/sat-convert-cfdi-data.mdx';
import { mxSwSapienImportCfdiWorkflow } from '/snippets/workflows/mx/sw-sapien-import-cfdi-data.mdx';
import { mxSwSapienRegisterPartyWorkflow } from '/snippets/workflows/mx/sw-sapien-register-party-data.mdx';
import { mxSubscribeImportWorkflow } from '/snippets/workflows/mx/mx-subscribe-import-data.mdx';
...
<Card iconType="duotone" title="SAT import CFDI workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=sat-convert-cfdi" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={mxSatConvertCfdiWorkflow} />
  </Tab>
  <Tab title="Code">
...
<Card iconType="duotone" title="Efisco bulk import CFDIs workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=sw-sapien-import-cfdi" horizontal>
  Add to my workspace →
</Card>
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={mxSwSapienImportCfdiWorkflow} />
  </Tab>
  <Tab title="Code">
...
<Card iconType="duotone" title="Subscribe party to CFDI import workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=mx-subscribe-import" horizontal>
  Add to my workspace →
</Card>
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={mxSubscribeImportWorkflow} />
  </Tab>
  <Tab title="Code">
    Copy and paste into a new [Empty Party workflow](https://console.invopop.com/redirect/workflows/new?template=empty-party) code view.
    <SubscribeImport />
...
<Card iconType="duotone" title="SW Sapien register party workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=sw-sapien-register-party" horizontal>
  Add to my workspace →
</Card>
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={mxSwSapienRegisterPartyWorkflow} />
  </Tab>
  <Tab title="Code">
    Copy and paste into a new [Empty Party workflow](https://console.invopop.com/redirect/workflows/new?template=empty-party) code view.
    <RegisterParty />
...
<Steps>
  <Step title="Create the party">
    ...
    - **Tax ID Code** with the entity's RFC (_Registro Federal de Contribuyentes_)
...
<Steps>
  <Step title="Open the workflow">
    Navigate to the **Workflows** section in the Console and locate the bulk CFDI import workflow you created during setup. Click on it to open its details.
  </Step>
...
See our [Mexico FAQ](/faq/mexico) for common questions.
