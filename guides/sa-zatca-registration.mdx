...
|---|---|---|---|
| `developer` | ZATCA Developer (sandbox) portal | **Dummy** — any placeholder value is accepted | Wire up and smoke-test the onboarding flow end to end without touching a real ZATCA account. |
...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Saudi Arabia register party workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=sa-gov-sa-register" cta="Add to my workspace">
...
Unregistering a party from ZATCA can only be done by the **supplier**, directly in the **FATOORA portal**. Invopop has no action to do this on their behalf.
