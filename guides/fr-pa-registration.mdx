...
import { registerWorkflow } from '/snippets/workflows/fr/fr-pa-register-data.mdx';
import { unregisterWorkflow } from '/snippets/workflows/fr/fr-pa-unregister-data.mdx';
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={registerWorkflow} />
  </Tab>
  <Tab title="Code">
    <RegisterWorkflow />
  </Tab>
...
<Tabs>
  <Tab title="Workflow">
    <WorkflowDiagram workflow={unregisterWorkflow} />
  </Tab>
  <Tab title="Code">
    <UnregisterWorkflow />
  </Tab>
