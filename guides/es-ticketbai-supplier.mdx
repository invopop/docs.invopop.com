...
import { esTicketbaiUnregisterWorkflow } from '/snippets/workflows/es/ticketbai-unregister-data.mdx';
import { esTicketbaiSupplierRegistrationWorkflow } from '/snippets/workflows/es/ticketbai-supplier-registration-data.mdx';
