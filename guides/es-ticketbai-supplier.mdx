...
import UnregisterExample from '/snippets/workflows/templates/es/ticketbai-unregister.mdx';
import SupplierRegistration from '/snippets/workflows/templates/es/ticketbai-supplier-registration.mdx';
