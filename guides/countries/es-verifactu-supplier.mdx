...
These documents can be collected through a multi-step web form (_wizard_) which enabled through the _Supplier registration workflow_ created during [VERI\*FACTU Invoicing setup](/guides/countries/es-verifactu). 
...
<Steps>
  ...
  <Step title="Upload documents">
    ...
    [Upload identity images](/api-ref/apps/verifactu/idenity-upload)<br />
