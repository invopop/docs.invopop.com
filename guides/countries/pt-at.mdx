...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="Supplier post-registration workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=pt-at-postregistration" cta="Select a workspace to use this template">
...
<Step title="Configure the supplier registration workflow">
  <Tabs>
    <Tab title="Template">
      <Card iconType="duotone" title="Register Supplier workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=pt-at-register-supplier" cta="Select a workspace to use this template">
...
<Step title="Prepare the document processing workflow">
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="Issue Invoice through AT (Portugal)" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=at-issue-invoice" cta="Select a workspace to use this template">
      ...
      <Tab title="Build from scratch">
          ...
          In [Console](https://console.invopop.com), create a new workflow and choose **Empty Invoice workflow** as the base. Then name the workflow with a descriptive label such as "Send invoice to InvoiceXpress".
