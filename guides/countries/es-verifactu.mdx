...
The process is best explained looking at the workflow steps:
    ...
    3. **Notify via Email:** sends an email to the supplier with the registration link. This step can be replaced with a webhook if you wish to handle notifications within your own systems. 
