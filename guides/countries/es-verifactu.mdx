...
The process is best explained looking at the workflow steps:
    ...
    <Note>In sandbox, the supplier will be approved as long as the original agreement is uploaded, even if it's not signed. If you want to test rejection, upload any other PDF document. IDs will be ignored.</Note>
