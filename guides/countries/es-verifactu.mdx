...
import WorkflowExample from '/snippets/workflows/templates/es/verifactu.mdx';
import B2CInvoice from '/snippets/invoices/es/verifactu-b2c-invoice.mdx';
import B2BInvoice from '/snippets/invoices/es/verifactu-b2b-invoice.mdx';
