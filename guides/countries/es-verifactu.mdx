...
These documents will be collected through a multi-step web form (_wizard_) which is sent to the supplier through the _Supplier Registration Workflow_ we created during setup. 
...
To create and onboard suppliers:
