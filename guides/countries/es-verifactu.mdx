...
<Steps>
  <Step title="Upload a Supplier">
    ...
    <Frame>
      <img
        width="450"
        src="/guides/images/es-verifactu-supplier-empty.png"
  ...
  <Step title="Send the Supplier to the registration workflow">
    ...
    <Frame>
      <img
        width="450"
        src="/guides/images/es-verifactu-supplier-registered.png"
...
<Steps>
  ...
  <Step title="Send the Invoice to the VERI*FACTU invoice workflow">
    ...
    - The `Silo Entry ID` of the invoice
...
<Steps>
  ...
  <Step title="Send the Credit Note to the VERI*FACTU invoice workflow">
    ...
    - The `silo_entry_id` of the credit note from step 1
    - The VERI\*FACTU invoice workflow ID
...
<Steps>
  ...
  <Step title="Send the Corrective Invoice to the VERI*FACTU invoice workflow">
    ...
    - The `Silo Entry ID` of the corrective invoice you've just uploaded.
    - The VERI\*FACTU invoice workflow ID
