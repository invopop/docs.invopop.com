...
<Steps>
  ...
  <Step title="Configure the supplier registration workflow">
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="VERI*FACTU supplier registration workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=es-verifactu-supplier-registration" cta="Select a workspace to use this template">
      ...
      <Tab title="Build from scratch">
        ...
        In [Console](https://console.invopop.com), create a new workflow and choose [Empty Party workflow](https://console.invopop-staging.com/redirect/workflows/new?template=empty-party) as the base. Then name the workflow with a descriptive label such as "VERI*\FACTU Supplier Registration".
  ...
  <Step title="Configure invoice workflow">
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="VERI*FACTU invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=es-verifactu-invoice" cta="Select a workspace to use this template">
