...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="DIAN-Colombia Invoice Workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=co-dian-invoice">
    Open in Console →
    </Card>
  ...
  <Tab title="Build from scratch">
    In [Console](https://console.invopop.com) create a new workflow and select **Empty Invoice workflow** in the template selector, then add the following steps:
      ...
      4. **Generate PDF** - Select "es-Spanish" as the Locale.
