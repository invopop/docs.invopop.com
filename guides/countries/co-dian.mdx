...
<Steps>
  ...
  <Step title="Create a workflow">
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="DIAN-Colombia Invoice Workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=co-dian-invoice" cta="Select a workspace to use this template">
