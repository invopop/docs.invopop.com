...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="DIAN-Colombia Invoice Workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=co-dian-invoice" cta="Select workspace to create workflow in Console">
