...
import B2BInvoice from '/snippets/invoices/de/regular-b2b-invoice.mdx'
import B2CInvoice from '/snippets/invoices/de/regular-b2c-invoice.mdx'
import B2BAdditional from '/snippets/invoices/de/b2b-additional.mdx'
