...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="XInvoice Workflow Template" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=de-x-rechnung" cta="Select workspace to create workflow in Console">
