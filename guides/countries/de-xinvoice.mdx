...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="XInvoice workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=de-x-rechnung" cta="Select a workspace to use this template">
