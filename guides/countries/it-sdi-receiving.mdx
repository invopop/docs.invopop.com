...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="IAPR Register Party Workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-register-customer" cta="Select workspace to create workflow in Console">
...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Register SDI Customer" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-import-invoices"  cta="Select workspace to create workflow in Console">
