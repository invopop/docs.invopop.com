...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="IAPR Register Party Workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-register-customer" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Register SDI Customer" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-import-invoices"  cta="Select a workspace to use this template">
