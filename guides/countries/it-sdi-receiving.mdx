...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="SDI register party workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=it-sdi-register-customer" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="SDI register customer" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=it-sdi-import-invoices"  cta="Select a workspace to use this template">
