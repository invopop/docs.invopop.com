...
<Note>
  Getting started with Portugal? We recommend our [AT Portugal app](/guides/countries/pt-invoicexpress). InvoiceXpress should only be used if you are an existing IX customer.
</Note>
