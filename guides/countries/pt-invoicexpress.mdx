...
<Step title="Configure the supplier registration workflow">
  <Tabs>
    <Tab title="Template">
      <Card iconType="duotone" title="InvoiceXpress register supplier workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=pt-ix-register-supplier" cta="Select a workspace to use this template">
...
<Step title="Prepare Invoice Workflow">
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="InvoiceXpress issue invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=pt-ix-issue-invoice" cta="Select a workspace to use this template">
