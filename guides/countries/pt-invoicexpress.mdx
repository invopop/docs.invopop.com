...
<Step title="Configure the supplier registration workflow">
  <Tabs>
    ...
    <Tab title="Build from scratch">
        ...
        In [Console](https://console.invopop.com), create a new workflow and choose **Empty Party workflow** as the base. Then name the workflow with a descriptive label such as "InvoiceXpress Register Supplier".
...
<Step title="Prepare Invoice Workflow">
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="Issue Invoice through InvoiceXpress" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-send" cta="Select workspace to create workflow in Console">
