...
<Step title="Create invoice workflow">
    ...
    <Tabs>
      <Tab title="Template">
        ...
        <Card iconType="duotone" title="Issue TicketBAI Invoice Workflow Template" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-send" cta="Select workspace to create workflow in Console">
        This workflow will issue an invoice through TicketBAI.
        </Card>
      </Tab>
      <Tab title="Code">
        Copy and paste into a new **Blank Invoice workflow** code view. This example adds support for setting states on silo entries which we strongly recomend.
        <WorkflowExample />
      </Tab>
