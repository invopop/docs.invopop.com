...
import WorkflowExample from '/snippets/workflows/templates/es/ticketbai.mdx'
import B2BInvoice from '/snippets/invoices/es/ticketbai-b2b-invoice.mdx'
import B2CInvoice from '/snippets/invoices/es/ticketbai-b2c-invoice.mdx'
