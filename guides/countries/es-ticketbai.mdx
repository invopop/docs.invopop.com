...
<Step title="Create invoice workflow">
    ...
    <Tabs>
      <Tab title="Template">
        ...
        <Card iconType="duotone" title="Issue TicketBAI Invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=es-ticketbai-invoice" cta="Select a workspace to use this template">
