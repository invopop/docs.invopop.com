...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="IAPR Invoice Workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=gr-iapr-invoice">
    Open in Console →
    </Card>
