...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="IAPR Invoice Workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=gr-iapr-invoice" cta="Select a workspace to use this template">
