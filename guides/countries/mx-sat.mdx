...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="SAT supplier post-registration workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=sat-postregistration" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="SAT register supplier workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=mx-sat-register-supplier" cta="Select a workspace to use this template">
...
<Step title="Prepare Invoice Workflow">
    ...
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="SAT issue invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=sat-issue-invoice" cta="Select a workspace to use this template">
      ...
      <Tab title="Build from scratch">
          ...
          In [Console](https://console.invopop.com), create a new workflow and choose [Empty Invoice workflow](https://console.invopop-staging.com/redirect/workflows/new?template=empty-invoice) as the base. Then name the workflow with a descriptive label such as "Issue SAT Invoices".
