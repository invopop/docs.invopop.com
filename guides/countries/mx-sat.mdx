...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="SAT supplier post-registration workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=sat-postregistration" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="SAT register supplier workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=mx-sat-register-supplier" cta="Select a workspace to use this template">
...
<Step title="Prepare Invoice Workflow">
    ...
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="SAT issue invoice workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=sat-issue-invoice" cta="Select a workspace to use this template">
