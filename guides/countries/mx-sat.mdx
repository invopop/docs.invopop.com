...
<Tabs>
  ...
  <Tab title="Build from scratch">
      ...
      In [Console](https://console.invopop.com), create a new workflow and choose **Empty Party workflow** as the base. Then name the workflow with a descriptive label such as "SAT Post-registration flow".
...
<Tabs>
  <Tab title="Template">
    ...
    This workflow will issue a registration request for a supplier to complete in order to issue invoices through SAT.
    </Card>
  </Tab>
  <Tab title="Code">
    Copy and paste into a new **Blank Party workflow** code view.
  ...
  <Tab title="Build from scratch">
      ...
      In [Console](https://console.invopop.com), create a new workflow and choose **Empty Party workflow** as the base. Then name the workflow with a descriptive label such as "SAT Register Supplier".
...
<Step title="Prepare Invoice Workflow">
    ...
    <Tabs>
      <Tab title="Template">
        <Card iconType="duotone" title="Issue SAT Invoice Workflow Template" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-send" cta="Select workspace to create workflow in Console">
        This workflow will issue an invoice through SAT.
        </Card>
      </Tab>
      <Tab title="Code">
