...
This is a standard B2C invoice from a Mexican supplier to a Mexican físical person with tax details, but no specific tax declaration requirements. This would be for a larger sale when the "Global Invoice" does not apply.
