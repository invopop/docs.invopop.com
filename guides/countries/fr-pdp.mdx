...
France handles e-invoicing through approved PDP (Plateforme de Dématérialisation Partenaire) platforms as part of its electronic invoicing reform. Invopop is an officially approved PDP platform, as listed on the [French government's official list of approved platforms](https://www.impots.gouv.fr/liste-des-plateformes-agreees-immatriculees-sous-reserve).
...
- **Report status updates** to DGFiP throughout the invoice lifecycle
- **Handle annuaire registration** for French e-invoicing directory compliance
