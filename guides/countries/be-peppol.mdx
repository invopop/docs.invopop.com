...
If this is your first time registering for Peppol in Belgium, you will need to request a migration key from BOSA (Belgian Federal Public Service Policy and Support, FPS BOSA). This requires setting up a migration workflow **instead of the standard registration workflow** with the following steps:
