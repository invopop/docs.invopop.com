...
If this is your first time registering for Peppol in Belgium, you will need to request a migration key from BOSA (Belgian Organization for Standardization and Accreditation). This requires setting up a migration workflow **instead of the standard registration workflow** with the following steps:
