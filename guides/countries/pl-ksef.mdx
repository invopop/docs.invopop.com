...
<img width="100%" src="/guides/images/pl-ksef-portal.png" alt="Connect KSeF app" />
</Frame>
...
<Frame>
<img width="354" src="/guides/images/pl-ksef-connect.png" alt="Connect KSeF app" />
</Frame>
...
<Tabs>
  ...
  <Tab title="Build from scratch">
      ...
      <Frame caption="KSeF Invoice Workflow"><img width="380" src="/guides/images/pl-ksef-sending-workflow.png" alt="Sending invoice workflow" /></Frame>
...
GOBL Invoices sent to KSeF require the following properties in order to perform the correct normalization and validation steps. Invopop will try to assign these automatically, but we recommend defining `$regime` to be set to [`PL`](https://docs.gobl.org/regimes/pl)
