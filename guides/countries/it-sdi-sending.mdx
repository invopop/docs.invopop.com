...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="SDI send invoice workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=it-sdi-send" cta="Select a workspace to use this template">
