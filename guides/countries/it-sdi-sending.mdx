...
First, review our [workflows guide](/guides/features/workflows) to understand the basics of setting up workflows, then create a workflow with these essential steps:
