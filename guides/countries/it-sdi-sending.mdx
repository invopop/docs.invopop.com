...
<Tabs>
  <Tab title="Template">
    This workflow template signs and converts the GOBL document into the FatturaPA XML format and then sends it to SDI.
    <Card iconType="duotone" title="Send SDI Invoice" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-send">
    Open in Console →
    </Card>
