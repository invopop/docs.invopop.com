...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Send SDI Invoice" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-send" cta="Select workspace to create workflow in Console">
