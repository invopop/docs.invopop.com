...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Send SDI Invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=it-sdi-send" cta="Select a workspace to use this template">
