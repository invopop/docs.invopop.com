...
import WorkflowExample from '/snippets/workflows/templates/br/issue-nfs-e.mdx'
import PostRegistration from '/snippets/workflows/templates/post-registration-flow.mdx'
import RegisterSupplier from '/snippets/workflows/templates/br/register-supplier.mdx'
import Supplier from '/snippets/workflows/templates/br/supplier.mdx'
import ServiceNote from '/snippets/workflows/templates/br/service-note.mdx'
