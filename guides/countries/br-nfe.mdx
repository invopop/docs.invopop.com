...
<Step title="Prepare Invoice Workflow">
  <Tabs>
    ...
    <Tab title="Build from scratch">
        ...
        In [Console](https://console.invopop.com), create a new workflow and choose **Empty Invoice workflow** as the base. Then name the workflow with a descriptive label such as "Issue NFS-e".
