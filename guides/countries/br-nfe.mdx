...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="Supplier post-registration workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=br-nfs-e-postregistration" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="Register Supplier workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=br-register-supplier" cta="Select a workspace to use this template">
...
<Step title="Prepare Invoice Workflow">
  <Tabs>
    <Tab title="Template">
      <Card iconType="duotone" title="Issue NFS-e Invoice workflow" icon="code-branch" href="https://console.invopop-staging.com/redirect/workflows/new?template=br-nfs-e-invoice" cta="Select a workspace to use this template">
