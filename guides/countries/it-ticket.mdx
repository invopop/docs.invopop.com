...
<Tabs>
  <Tab title="Template">
    ...
    <Card iconType="duotone" title="Smart Receipts supplier post-registration workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=ticket-post-registration" cta="Select a workspace to use this template">
...
<Tabs>
  <Tab title="Template">
    <Card iconType="duotone" title="Smart receipts supplier registration workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=ticket-register-supplier" cta="Select a workspace to use this template">
...
<Step title="Prepare Invoice Workflow">
    <Tabs>
      <Tab title="Template">
        ...
        <Card iconType="duotone" title="Smart Receipts issue receipt workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=it-ticket-send" cta="Select a workspace to use this template">
...
<Tabs>
      <Tab title="Template">
        ...
        <Card iconType="duotone" title="Smart Receipts void receipt workflow" icon="code-branch" href="https://console.invopop.com/redirect/workflows/new?template=ticket-void-receipt" cta="Select a workspace to use this template">
