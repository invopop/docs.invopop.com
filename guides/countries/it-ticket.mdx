...
<Warning>
  These credentials will expire every 90 days. After updating the credentials, you will need to enter the new credentials in the registration form again. You can use the same link to do this.
</Warning>
