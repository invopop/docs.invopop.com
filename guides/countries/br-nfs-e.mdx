...
The NFS-e (Nota Fiscal de Serviços Eletrônica) is the digital invoice service used in Brazil to report tax information to municipalities. Each municipality has its own rules, format, and API for issuing service notes.
