...
Finnish businesses receive their e-invoices over two networks: the domestic operator network, where around 370,000 companies get theirs in the *Finvoice* format, and Peppol, with roughly 13,000 end users. The [Finland app](/apps/finland) covers both, delivering through the accredited Finnish operator Invopop has partnered with, in the format the receiver's network expects.
...
Finvoice makes the payment order mandatory on **every** invoice, credit notes included. Since most Finnish receivers get their invoices as Finvoice, every Finnish invoice must carry:
