...
Finnish businesses receive their e-invoices over two networks *Finvoice*/*TEAPPSXML* and Peppol. The [Finland app](/apps/finland) covers both, delivering through the accredited Finnish operator Invopop has partnered with, in the format the receiver's network expects.

You never pick a network. Instead, the receiver's e-invoice address will resolve the routing.
