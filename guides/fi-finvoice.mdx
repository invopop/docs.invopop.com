...
Finnish businesses receive their e-invoices over two networks: the domestic operator network (*Finvoice*/*TEAPPSXML*) and Peppol. The [Finland app](/apps/finland) covers the domestic network, delivering through the accredited Finnish operator Invopop has partnered with, in the format the receiver's operator expects.

If your receiver is on Peppol, use the [Peppol app](/apps/peppol) instead. Look them up at [verkkolaskuosoite.fi](https://verkkolaskuosoite.fi) to see which network they are on — it lists both. Within the domestic network you never pick a format: the receiver's e-invoice address resolves the routing.
