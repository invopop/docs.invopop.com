...
import { chargebeeCbZugferdWorkflow } from '/snippets/workflows/chargebee/cb-zugferd.mdx';
import { chargebeeCbXrechnungWorkflow } from '/snippets/workflows/chargebee/cb-xrechnung.mdx';
