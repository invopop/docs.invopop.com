...
import RegisterWorkflow, { dkNemhandelRegisterWorkflow } from '/snippets/workflows/dk/nemhandel-register.mdx';
import UnregisterWorkflow, { dkNemhandelUnregisterWorkflow } from '/snippets/workflows/dk/nemhandel-unregister.mdx';
