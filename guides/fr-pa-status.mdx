...
| <Badge color="orange">207</Badge><br /> <small>En litige / Disputed</small> | [bill/status](https://docs.gobl.org/draft-0/bill/status#status) | Optional. Dispute the invoice; requires a [reason](#available-reasons-). |
