...
One worked GOBL example per lifecycle code. Each is a complete, ready-to-build
document — every status references the same invoice (`INV-2026-0042`,
supplier SIREN `698680774`). Codes `200` (Déposée) and `213` (Rejetée) are
emitted automatically by Invopop and are not authored by you.
...
<AccordionGroup>
  ...
  <Accordion title="210 — Refusée (Rejected)">
