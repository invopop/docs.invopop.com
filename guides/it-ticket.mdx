...
import TicketIssueReceipt, { itTicketSendWorkflow } from '/snippets/workflows/it/ticket-send.mdx';
import TicketVoidReceipt, { itTicketVoidReceiptWorkflow } from '/snippets/workflows/it/ticket-void-receipt.mdx';
