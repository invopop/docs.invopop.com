...
import ExampleAccordion from '/snippets/invoices/fr/facturx-accordion.mdx'
...
Once you have saved in Invopop, select <kbd>Run workflow</kbd> and select "Factur-X invoice workflow" from the sidebar and the state should change to <Badge color="blue">Sent</Badge>.
