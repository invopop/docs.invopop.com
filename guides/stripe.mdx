...
<Frame caption="Track invoice status directly in your Stripe dashboard">
  ![stripe details](/assets/guides/stripe-details.png)
</Frame>
...
<Frame caption="View the job information">
  ![stripe job](/assets/guides/stripe-job-details.png)
</Frame>
...
<Frame caption="Install Invopop in Stripe">
  ![stripe install](/assets/guides/stripe-install.png)
</Frame>
...
<Frame caption="Connect your Invopop account">
  ![stripe connect](/assets/guides/stripe-connect.png)
</Frame>
...
<Frame caption="Choose your workspace">
  ![stripe select workspace](/assets/guides/stripe-select-workspace.png)
</Frame>
...
<Frame caption="Show your tax ID on invoices">
  ![stripe tax id](/assets/guides/stripe-tax-id.png)
</Frame>
...
<Frame caption="Review your configuration">
  ![stripe settings](/assets/guides/stripe-settings.png)
</Frame>
...
<Frame caption="Invoice processed successfully in Stripe">
  ![stripe invoice status](/assets/guides/stripe-invoice-success.png)
</Frame>
...
<Frame caption="Job details in Invopop">
  ![stripe job details](/assets/guides/stripe-invopop-job.png)
</Frame>
...
<AccordionGroup>
  ...
  <Frame caption="Select a different workflow in Stripe">
    ![stripe change workflow](/assets/guides/stripe-settings.png)
  </Frame>
  ...
  <Frame caption="Select a different workflow in Invopop">
    ![stripe change workflow](/assets/guides/stripe-invopop-settings.png)
  </Frame>
  ...
  <Frame caption="Import historic invoices">
    ![stripe import historic invoices](/assets/guides/stripe-import-historic-invoices.png)
  </Frame>
  ...
  <Frame caption="Update invoice import trigger in Stripe">
    ![stripe import trigger](/assets/guides/stripe-import-trigger.png)
  </Frame>
  ...
  <Frame caption="Update invoice import trigger">
    ![stripe import trigger](/assets/guides/stripe-when-paid.png)
  </Frame>
