...
import { stripeInvoiceWorkflow } from '/snippets/workflows/stripe/stripe-invoice-data.mdx';
import { stripeVerifactuWorkflow } from '/snippets/workflows/stripe/stripe-verifactu-data.mdx';
import { stripePeppolWorkflow } from '/snippets/workflows/stripe/stripe-peppol-data.mdx';
import { stripeFranceWorkflow } from '/snippets/workflows/stripe/stripe-france-data.mdx';
