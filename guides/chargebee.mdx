...
<Steps>
  ...
  <Step title="Connect the Chargebee app">
    ...
    - **Workflow:** The workflow that will process the invoices. You can select the one you created earlier. Only active and published workflows appear in this list — archived workflows and unpublished drafts are filtered out, so make sure to publish your workflow before configuring the app.
