...
Current and upcoming regulation for Saudi Arabia.
...
<Update label="Now" tags={["Phase 2", "B2B", "B2G", "B2C"]}>
  **Phase 2 — Integration phase begins**<br />
  ...
  |---------------|---------------|---------------|
  | [Clearance](/compliance/saudi-arabia) | B2B and B2G standard tax invoices | The invoice is submitted to Fatoora and cryptographically stamped by ZATCA *before* being issued to the buyer. Without clearance, the invoice is not valid. |
  | [Reporting](/compliance/saudi-arabia) | B2C simplified tax invoices | The invoice is issued to the customer at point of sale with its QR code and reported to Fatoora within 24 hours. |
