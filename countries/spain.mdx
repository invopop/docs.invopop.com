...
<Card title="Spain's invoicing e-regulation timeline" size="20" icon="timeline" href="/timelines/spain" horizontal>
...
<Columns cols="2">
  ...
  <Card title="TicketBAI Spain" icon="https://assets.invopop.com/apps/ticketbai/icon.svg" href="/api-ref/introduction" horizontal>Get covered →</Card>
  <Card title="Facturae Spain" icon="https://assets.invopop.com/apps/facturae/icon.svg" href="/api-ref/introduction" horizontal>Get covered →</Card>
...
<AccordionGroup>
  ...
  <Accordion title="Facturae (B2G)">
    ...
    <Card title="Facturae Spain" size="20" icon="https://assets.invopop.com/apps/facturae/icon.svg" href="/apps/verifactu-spain" horizontal>
      Connect the app to get you covered →
    </Card>
