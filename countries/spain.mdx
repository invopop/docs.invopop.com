...
<Card title="Spain's invoicing e-regulation timeline" icon="timeline" horizontal href="spain-timeline">
...
<Columns cols="2">
  <Card title="VERI*FACTU Spain" icon=" <VerifactuIcon size={24} /> " horizontal href="/apps/verifactu-spain">
    Get covered →
  </Card>
  <Card title="TicketBAI Spain" icon=" <TbaiIcon size={24} /> " horizontal href="/api-ref/introduction">
    Get covered →
  </Card>
  <Card title="Facturae Spain" icon=" <FacturaeIcon size={24} /> " horizontal href="/api-ref/introduction">
    Get covered →
  </Card>
  <Card title="SII" horizontal>
    Coming Q4 2025
  </Card>
</Columns>

Enable these **Invopop integrations** to issue compliant TicketBAI and VERI\*FACTU invoices from your merchant or ERP platform:
...
<AccordionGroup>
  ...
  <Accordion title="Facturae (B2G)">
    ...
    <Card title="Facturae Spain" icon=" <FacturaeIcon size={24} /> " horizontal href="/apps/verifactu-spain">
      Connect the app to get you covered →
    </Card>
  </Accordion>
</AccordionGroup>
...
<Note>
  Companies reporting to TicketBAI or SII are exempt from issuing VER\*FACTU
</Note>

<Info>
  B2C invoicing is not required in Spain, though it is available in VERI\*FACTU through the [simplified invoice](https://docs.gobl.org/addons/es-verifactu-v1#es-verifactu-doc-type) type.
</Info>
...
<AccordionGroup>
  <Accordion title="TicketBAI (B2B)">
    ...
    <Card title="TicketBAI Spain" icon=" <TbaiIcon size={24} /> " horizontal href="/apps/ticketbai-spain">
      Connect the app to get you covered →
    </Card>
  </Accordion>
</AccordionGroup>
...
<Note>
  B2C invoicing is not required for the Basque Country, though it is available in TicketBAI through the [simplified invoice](https://docs.gobl.org/addons/es-verifactu-v1#es-verifactu-doc-type) type.
</Note>
