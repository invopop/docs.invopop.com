...
Spain’s invoicing and reporting systems stems from its decentralized fiscal structure, where regions like the Basque Country and Navarra manage their own tax authorities, alongside the national AEAT. 
...
## Invoicing in Álava, Gipuzkoa and Bizkaia

Spain’s Haciendas Forales are the provincial tax authorities of the Basque Country (Álava, Bizkaia, and Gipuzkoa), which possess unique fiscal autonomy under the Spanish Constitution. These provinces collect and manage most taxes through their own tax administrations.
...
<AccordionGroup>
  <Accordion title="Required invoice content">
