...
Invopop partners with a local technology provider, ([Plemsi](https://plemsi.com)), to generate electronic invoices and issue them in the Colombian tax authority (DIAN).
