...
- there is an `id` property that uniquely identifies this entry,
...
- An envelope ID generated in the last request when we uploaded the Invoice.
...
generated for the workflow and envelope:

```bash
curl -H "Authorization: Bearer $INVOPOP_TOKEN" -X POST -F workflow_id=0d9602ab-a2e2-413c-adf0-7abf4dd25c12 -F envelope_id=181ecd5a-f242-11ec-82f1-0242ac150010 "https://api.invopop.com/transform/v1/jobs?wait=30" | jq .
```
...
```json
{
  ...
  "envelope_id": "181ecd5a-f242-11ec-82f1-0242ac150010",
