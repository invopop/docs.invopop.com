...
3. Use the Name field to give this new workflow an easy way to be identified, like
   "Process Invoice".

4. In the steps section, tap the "**+**" button. You'll need to repeat this step for the
