...
|    |    |
|-----------|------------|
|  API Reference | <Icon icon="code" /> [Update an entry](/api-ref/silo/entries/update-an-entry)<br /><Icon icon="code" /> [Fetch an entry](/api-ref/silo/entries/fetch-an-entry) |
