...
Invopop API Keys are generated using the [Console](https://console.invopop.com). Enter "Configuration", then "API Keys", and tap "New API Key". Enter some reference details and click "Save". You'll be presented with a screen showing a new token. You **must** copy and paste this token, as we do not store it anywhere. If you loose it, you'll need to create a
new API key.
