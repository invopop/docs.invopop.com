...
The silo entry must have signer fields set (given name, surname, and role) before calling. Use together with `POST /identity`, then call `POST /confirm` to finalise.
